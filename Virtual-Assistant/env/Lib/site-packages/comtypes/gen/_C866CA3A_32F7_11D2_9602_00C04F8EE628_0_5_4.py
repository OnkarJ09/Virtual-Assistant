...
__all__ = [
    'DISPID_SGRSTransitions', 'SAFT11kHz16BitMono',
    'SpeechRecognizerState', 'DISPID_SpeechRecognizer',
    'DISPID_SPRuleName', 'DISPID_SGRName', 'SPAS_STOP',
    'eWORDTYPE_ADDED',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCRequestedUIType', 'SVSFParseAutodetect',
    'DISPID_SRCCreateResultFromMemory', 'SPWORDTYPE',
    'DISPID_SRCVoice', 'ISpSerializeState', 'SpeechGrammarWordType',
    'DISPID_SWFESamplesPerSec', 'SVSFParseMask',
    'DISPID_SRCEInterference', 'SAFTCCITT_uLaw_44kHzMono',
    'tagSTATSTG', 'DISPID_SRRecognizer', 'SpeechAudioVolume',
    'SPEVENTSOURCEINFO', 'DISPID_SPPChildren', 'DISPID_SGRsCommit',
    'SAFTText', 'SPFM_OPEN_READONLY', 'DISPID_SPRsItem',
    'SAFT48kHz16BitStereo', 'ISpeechAudioStatus',
    'SpeechCategoryAudioOut', 'DISPID_SRRGetXMLErrorInfo',
    'ISpeechRecognizer', 'SPSEMANTICFORMAT', 'DISPID_SVSRunningState',
    'DISPID_SPPsItem', 'DISPID_SPACommit', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SPRulesItem', 'DISPID_SOTCEnumerateTokens',
    'ISpeechBaseStream', 'DISPID_SRRGetXMLResult',
    'SDA_One_Trailing_Space', 'SAFT16kHz16BitMono',
    'DISPID_SOTGetAttribute', 'SPGS_EXCLUSIVE', 'eLEXTYPE_PRIVATE15',
    'eLEXTYPE_PRIVATE16', 'DISPID_SMSGetData', 'SPAR_Low',
    'SPAO_NONE', 'DISPID_SRSClsidEngine', 'DISPID_SVSkip',
    'DISPID_SWFEBitsPerSample', 'SpeechRunState',
    'DISPID_SOTMatchesAttributes', 'SPEI_VOICE_CHANGE', 'SVP_13',
    'eLEXTYPE_PRIVATE1', 'DISPID_SASNonBlockingIO', 'SRSInactive',
    'eLEXTYPE_VENDORLEXICON', 'SREHypothesis', 'SRAORetainAudio',
    'DISPID_SRGCmdLoadFromResource', 'SpeechRuleState',
    'DISPID_SGRSAddSpecialTransition', 'SINoSignal',
    'SAFT8kHz16BitStereo', 'ISpeechObjectToken', 'SPCONTEXTSTATE',
    'DISPID_SRIsShared', 'SpeechCategoryAudioIn',
    'SpInProcRecoContext', 'SAFTADPCM_22kHzMono', 'STCAll',
    'SP_VISEME_20', 'DISPID_SpeechMemoryStream',
    'SVEStartInputStream', 'DISPID_SPIRetainedSizeBytes',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechLoadOption', 'SGSDisabled',
    'ISpeechPhraseElements', 'ISpPhraseAlt', 'SPEI_MIN_SR', 'SVP_12',
    'ISpPhoneConverter', 'DISPID_SPCIdToPhone', 'SPDKL_LocalMachine',
    'SPWT_PRONUNCIATION', 'SpeechAudioFormatGUIDText',
    'eLEXTYPE_PRIVATE20', 'SDKLCurrentUser', 'SPWT_DISPLAY',
    'DISPID_SGRSTPropertyId', 'ISpeechLexiconPronunciation',
    'SITooLoud', 'eLEXTYPE_PRIVATE10', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPEI_RECOGNITION', 'ISpeechPhraseInfo',
    'DISPID_SDKGetStringValue', 'DISPID_SRGRecoContext', 'SPRULE',
    'DISPID_SRGSetTextSelection', 'ISpeechPhraseRules',
    'SPWORDPRONUNCIATION', 'ISpDataKey', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRCPause', 'DISPID_SPRules_NewEnum', 'DISPID_SOTCId',
    'DISPIDSPTSI_ActiveOffset', 'SPAUDIOSTATUS', 'DISPID_SPPsCount',
    'SpeechPropertyResponseSpeed', 'DISPID_SRCEAdaptation',
    'SpeechDictationTopicSpelling', 'DISPID_SGRsFindRule',
    'DISPID_SPIAudioStreamPosition', 'SRSInactiveWithPurge',
    'SPSSuppressWord', 'SDA_Consume_Leading_Spaces',
    'ISpeechLexiconWord', 'SRERecognition', 'SPSLMA',
    'DISPID_SPRuleConfidence', 'SECLowConfidence',
    'tagSPPROPERTYINFO', 'SPWORDLIST', 'SRAImport', 'SVEPhoneme',
    'DISPID_SRDisplayUI', 'WAVEFORMATEX', 'SVPOver',
    'DISPID_SpeechRecoContextEvents', 'SPPS_NotOverriden',
    'DISPID_SPIEnginePrivateData', 'SPSInterjection',
    'ISpeechPhraseReplacements', 'SAFTNoAssignedFormat',
    'ISpeechGrammarRule', 'DISPID_SRGetFormat', 'SDKLCurrentConfig',
    'SREFalseRecognition', 'SPEI_INTERFERENCE',
    'DISPID_SLGenerationId', 'DISPID_SRCEPropertyNumberChange',
    'ISpeechPhraseAlternate', 'STCInprocHandler', 'ISpStreamFormat',
    'ISpObjectWithToken', 'SpeechTokenKeyAttributes',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT12kHz16BitStereo',
    'SAFTADPCM_8kHzMono', 'DISPID_SPARecoResult',
    'DISPID_SPCPhoneToId', 'SVF_None', 'eLEXTYPE_RESERVED4',
    'tagSPTEXTSELECTIONINFO', 'SSFMCreate', 'ISpAudio',
    'SREStreamStart', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SPRuleNumberOfElements', 'SPEI_PROPERTY_STRING_CHANGE',
    'eLEXTYPE_PRIVATE3', 'SVP_5', 'DISPID_SREmulateRecognition',
    'SAFT24kHz16BitMono', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SVGetProfiles', 'SBONone', 'DISPID_SRGState',
    'SPEI_SR_BOOKMARK', 'SVPAlert', 'SAFTNonStandardFormat',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPRDisplayAttributes',
    'SRAInterpreter', 'DISPID_SLGetPronunciations',
    'DISPID_SABIEventBias', 'SPBINARYGRAMMAR',
    'SAFTCCITT_ALaw_44kHzMono', 'SpeechVisemeType',
    'DISPID_SDKSetLongValue', 'SAFT8kHz16BitMono', 'SP_VISEME_10',
    'SAFT24kHz8BitStereo', 'SPWT_LEXICAL', 'SpeechAudioState',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SpeechObjectTokenCategory',
    'SPAR_High', 'ISpStream', 'SPPHRASERULE', 'SPINTERFERENCE_NONE',
    'DISPID_SOTDataKey', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SVP_11', 'SECFIgnoreCase', 'SGRSTTRule', 'SSTTTextBuffer',
    'DISPID_SRCEventInterests', 'SpeechRecoContextState',
    'SPFM_CREATE', 'ISpEventSource', 'SPEI_ADAPTATION',
    'DISPID_SpeechGrammarRuleState', 'SPSHT_OTHER', 'SpVoice',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPFILEMODE', 'SPGRAMMARSTATE',
    'DISPID_SRCERequestUI', 'ISpPhoneticAlphabetConverter',
    'ISpShortcut', 'SPEI_MIN_TTS', 'DISPID_SBSFormat',
    'SpCompressedLexicon', 'SPAR_Unknown', 'SPEI_REQUEST_UI',
    'eLEXTYPE_RESERVED10', 'DISPID_SRGRules', 'SpeechVoicePriority',
    'DISPID_SPPNumberOfElements', 'DISPID_SABIBufferSize',
    'DISPID_SRGCmdLoadFromFile', 'ISpeechPhraseProperty',
    'SPAR_Medium', 'DISPID_SRGDictationLoad', 'SPXMLRESULTOPTIONS',
    'SPWORD', 'SpeechInterference', 'SpObjectTokenCategory',
    'eLEXTYPE_PRIVATE6', 'DISPID_SRCESoundStart',
    'DISPID_SRCEHypothesis', 'SAFT44kHz8BitMono',
    'DISPID_SPRs_NewEnum', 'ISpRecognizer2',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpRecognizer',
    'SVSFIsFilename', 'SpNotifyTranslator', 'DISPID_SRAudioInput',
    'ISpeechRecoResult2', 'DISPID_SGRId', 'DISPID_SOTsCount',
    'DISPID_SWFEChannels', 'SpeechMicTraining', 'DISPID_SGRSTsItem',
    'DISPID_SMSAMMHandle', 'DISPID_SpeechRecoResultTimes',
    'ISpeechAudio', 'SPPS_Function', 'DISPID_SpeechAudioFormat',
    'SAFTGSM610_22kHzMono', 'DISPID_SPELexicalForm', 'SpCustomStream',
    'DISPID_SVEVoiceChange', 'DISPID_SPERequiredConfidence',
    'SDTAudio', 'SAFT32kHz16BitStereo', 'DISPID_SRGCmdLoadFromMemory',
    'ISpeechRecoResultTimes', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SRCS_Disabled', 'DISPID_SOTGetDescription', 'SPEI_RESERVED1',
    'DISPID_SRGSetWordSequenceData', 'SRERequestUI',
    'SPDATAKEYLOCATION', 'DISPID_SVIsUISupported',
    'SpeechTokenIdUserLexicon', 'SRAONone',
    'SpeechPropertyResourceUsage', 'SP_VISEME_21',
    'SAFT12kHz8BitMono', 'SVF_Stressed', 'DISPID_SRCERecognition',
    'DISPID_SADefaultFormat', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SVPause', '_ISpeechVoiceEvents', 'SPFM_NUM_MODES',
    'ISpNotifySource', 'DISPID_SVVoice', 'SPAS_PAUSE',
    'SPRS_INACTIVE', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'STSF_LocalAppData', 'SWTAdded', 'ISpRecoContext2',
    'DISPID_SGRsAdd', 'SPEI_END_SR_STREAM', 'DISPID_SGRsItem',
    '_ISpeechRecoContextEvents', 'SINone', 'SPPS_RESERVED4',
    'SpeechRuleAttributes', 'SPCT_COMMAND',
    'DISPID_SGRSTPropertyName', 'SPRECORESULTTIMES',
    'DISPID_SLWLangId', 'SPRULESTATE', 'SpeechCategoryVoices',
    'DISPID_SPRuleFirstElement', 'DISPID_SpeechLexiconPronunciation',
    'ISpeechCustomStream', 'SVSFVoiceMask', 'SRTSMLTimeout',
    'SGRSTTEpsilon', 'SpeechRegistryLocalMachineRoot',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SpeechGrammarRule',
    'DISPID_SRGDictationSetState', 'SGLexical',
    'DISPID_SPISaveToMemory', 'DISPID_SRRTStreamTime',
    'SPINTERFERENCE_NOISE', 'ISpeechVoice', 'SpeechFormatType',
    'SPSHORTCUTTYPE', 'SpeechCategoryRecognizers',
    'ISpeechVoiceStatus', 'DISPID_SVEStreamStart', 'SPSNoun',
    'SPCT_SUB_DICTATION', 'DISPID_SpeechPhraseRules',
    'DISPID_SFSClose', 'DISPID_SpeechRecoContext',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SCSBaseStream',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRsCount', 'SGRSTTTextBuffer',
    'DISPID_SBSRead', 'DISPID_SGRSAddWordTransition',
    '__MIDL_IWinTypes_0009', 'SPEVENT', 'eWORDTYPE_DELETED',
    'DISPID_SAFGetWaveFormatEx', 'IInternetSecurityManager',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SREInterference',
    'SpMMAudioOut', 'SWPUnknownWordUnpronounceable', 'SSTTWildcard',
    'SpeechWordType', 'SVSFNLPMask', 'SpStreamFormatConverter',
    'SPSMF_UPS', 'DISPID_SPCLangId', 'SAFTADPCM_44kHzMono',
    'DISPID_SASFreeBufferSpace', 'SAFT8kHz8BitStereo',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SGRSTText',
    'SpeechTokenKeyFiles', 'SAFTTrueSpeech_8kHz1BitMono',
    'ISpResourceManager', 'SpStream', 'SVP_14', 'STCInprocServer',
    'SRARoot', 'DISPID_SPERetainedSizeBytes', 'SpObjectToken',
    'SPSHT_EMAIL', 'ISpPhoneticAlphabetSelection',
    'SAFTGSM610_11kHzMono', 'ISpeechLexiconPronunciations',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SVSLastResult', 'SPPHRASE',
    'DISPID_SGRs_NewEnum', 'ISpLexicon', 'SPRECOSTATE',
    'SAFTCCITT_uLaw_8kHzMono', 'SVSFIsNotXML', 'eLEXTYPE_PRIVATE12',
    'SSFMOpenReadWrite', 'SPSUnknown', 'SBOPause', 'DISPID_SPPParent',
    'DISPID_SMSADeviceId', 'DISPID_SRGDictationUnload',
    'SDA_Two_Trailing_Spaces', 'DISPID_SpeechGrammarRules',
    'SpeechStreamFileMode', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SVESentenceBoundary', 'DISPID_SVWaitUntilDone',
    'DISPID_SOTDisplayUI', 'SpeechUserTraining',
    'DISPID_SRGCmdSetRuleIdState', 'SAFT22kHz8BitStereo',
    'SPEI_VISEME', 'eLEXTYPE_USER', 'SP_VISEME_17',
    'SAFTADPCM_11kHzMono', 'SpeechVoiceSkipTypeSentence',
    'SP_VISEME_15', 'ISpXMLRecoResult', 'DISPID_SRCSetAdaptationData',
    'ISpeechPhraseInfoBuilder', 'SDTAll',
    'DISPID_SRSNumberOfActiveRules', 'IStream', 'SPXRO_SML',
    'SPVPRI_ALERT', 'DISPID_SFSOpen', 'DISPID_SLWWord',
    'SpeechEmulationCompareFlags', 'SRATopLevel', 'SREAllEvents',
    'SLTUser', 'SPSFunction', 'DISPID_SRCCmdMaxAlternates',
    'SpeechGrammarState', 'DISPID_SPIGrammarId',
    'SRERecoOtherContext', 'ISpVoice', 'DISPID_SpeechBaseStream',
    'SSSPTRelativeToCurrentPosition', 'SPRST_ACTIVE_ALWAYS',
    'SREAudioLevel', 'SPEI_WORD_BOUNDARY', 'SVP_9',
    'DISPID_SPEActualConfidence',
    'DISPID_SLAddPronunciationByPhoneIds', 'eLEXTYPE_PRIVATE11',
    'SVEWordBoundary', 'DISPID_SRCESoundEnd', 'SREStateChange',
    'SP_VISEME_12', 'SpeechWordPronounceable',
    'DISPID_SPPFirstElement', 'DISPID_SpeechFileStream',
    'SPVPRIORITY', 'SPEI_RESERVED6', 'DISPID_SPEAudioSizeBytes',
    'ISpNotifySink', 'DISPID_SRSAudioStatus', 'DISPID_SPILanguageId',
    'IEnumSpObjectTokens', 'SPAO_RETAIN_AUDIO', 'DISPID_SMSSetData',
    'SpeechPropertyComplexResponseSpeed', 'SPAUDIOBUFFERINFO',
    'DISPID_SWFEAvgBytesPerSec', 'SAFTCCITT_ALaw_8kHzStereo',
    'ISpeechWaveFormatEx', 'ISpeechAudioFormat', 'SGPronounciation',
    'DISPID_SAFSetWaveFormatEx', 'SRESoundEnd', 'SVEAllEvents',
    'DISPID_SRRTLength', 'SECFIgnoreKanaType', 'SpeechAllElements',
    'DISPID_SPAsItem', 'SPCS_DISABLED', 'DISPID_SPEsItem',
    'DISPID_SPRsCount', 'ISpeechTextSelectionInformation',
    'DISPID_SRRTimes', 'SRSEDone', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPPROPERTYINFO', 'DISPID_SpeechLexicon', 'SRCS_Enabled',
    'DISPID_SpeechRecoResult2', 'SpUnCompressedLexicon',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPEAudioStreamOffset',
    'ISpeechDataKey', 'DISPID_SOTCreateInstance',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SGRSTRule',
    'ISpGrammarBuilder', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SVDisplayUI', 'DISPID_SGRInitialState', 'ISpeechLexicon',
    'DISPID_SRCEAudioLevel', 'SPSERIALIZEDRESULT',
    ...
    'SPPS_SuppressWord', 'ISpeechObjectTokenCategory', 'SVEPrivate',
    'SpPhoneticAlphabetConverter', 'DISPID_SRProfile',
    'DISPID_SRCRecognizer', 'SpeechAudioFormatType',
    'DISPID_SGRsCommitAndSave', 'SPPS_Interjection', 'DISPID_SPRText',
    'DISPID_SPIGetText', 'DISPID_SRCEPropertyStringChange',
    'SAFTGSM610_44kHzMono', 'SVPNormal', 'DISPID_SAVolume',
    'DISPID_SpeechPhoneConverter', 'SAFT22kHz8BitMono',
    'ISpeechResourceLoader', 'SpeechEngineProperties',
    'SAFT16kHz8BitStereo', 'SpLexicon', 'DISPID_SASetState',
    'SAFTCCITT_uLaw_22kHzStereo', 'SP_VISEME_8',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPRNumberOfElements',
    'DISPID_SpeechAudioStatus', 'ISpRecoCategory', 'SVP_4', 'SVP_15',
    'DISPID_SDKDeleteValue', 'SPGS_ENABLED', 'SP_VISEME_0',
    'SP_VISEME_5', 'eLEXTYPE_PRIVATE8', 'SAFTCCITT_uLaw_44kHzStereo',
    'SpNullPhoneConverter', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SASState', 'SVSFIsXML', 'SPINTERFERENCE_TOOQUIET',
    'STCRemoteServer', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SVGetVoices',
    'DISPID_SWFEExtraData', 'ISpeechRecoResultDispatch',
    'SPDKL_CurrentConfig', 'SPPARTOFSPEECH', 'DISPID_SVSVisemeId',
    'SPPS_RESERVED2',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPEI_END_INPUT_STREAM', 'DISPID_SPIStartTime',
    'SSSPTRelativeToEnd', 'DISPID_SLPPartOfSpeech', 'SPEI_SR_PRIVATE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SAFT44kHz8BitStereo',
    'SAFT32kHz8BitStereo', 'SITooSlow', 'SRSEIsSpeaking',
    'DISPID_SPPs_NewEnum', 'SRADefaultToActive',
    'SpeechAddRemoveWord', 'SPSModifier', 'SAFT11kHz8BitStereo',
    'SVP_6', 'SAFTCCITT_ALaw_44kHzStereo', 'SPEI_RECO_STATE_CHANGE',
    'SGLexicalNoSpecialChars', 'SGSExclusive', 'DISPID_SRGId',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRCEStartStream', 'DISPID_SPAStartElementInResult',
    'SDTDisplayText', 'SREPrivate', 'DISPID_SPIReplacements',
    'SpeechRecoEvents', 'SPSHORTCUTPAIR', 'DISPID_SOTIsUISupported',
    'SPPHRASEREPLACEMENT', 'DISPID_SLPLangId',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPEs_NewEnum', 'SPPS_LMA',
    'SAFT12kHz16BitMono', 'SWPUnknownWordPronounceable',
    'SP_VISEME_18', 'eLEXTYPE_MORPHOLOGY', 'SGRSTTDictation',
    'DISPID_SPIRule', 'SpeechEngineConfidence', 'SVP_21',
    'DISPID_SVSpeak', 'eLEXTYPE_RESERVED8', 'SAFT24kHz16BitStereo',
    'ISpeechRecoResult', 'SRTStandard', 'SPEI_HYPOTHESIS',
    'DISPID_SOTGetStorageFileName', 'SpeechTokenValueCLSID',
    'DISPID_SpeechRecoResult', 'SPSHT_NotOverriden',
    'SAFT22kHz16BitStereo', 'ISpeechRecoContext', 'SVP_3',
    'DISPID_SRCCreateGrammar', 'DISPID_SDKSetBinaryValue',
    'SREStreamEnd', 'DISPID_SLWPronunciations',
    'DISPID_SPAPhraseInfo', 'SVEVoiceChange', 'DISPID_SLWs_NewEnum',
    'SpFileStream', 'SPPS_Noun', 'SPEI_TTS_AUDIO_LEVEL',
    'SpPhraseInfoBuilder', 'eLEXTYPE_PRIVATE5', 'DISPID_SPPValue',
    'SASClosed', 'DISPIDSPTSI', 'DISPID_SABufferNotifySize',
    'DISPID_SWFEFormatTag', 'DISPID_SVSInputWordLength',
    'SPDKL_DefaultLocation', 'DISPID_SpeechVoiceEvent', 'SP_VISEME_1',
    'DISPID_SpeechLexiconWords', 'SECFDefault',
    'SpTextSelectionInformation', 'DISPID_SpeechObjectTokens',
    'DISPID_SRCERecognizerStateChange', 'SGRSTTWord', 'DISPID_SVRate',
    'SpeechRecoProfileProperties', 'DISPID_SPRuleChildren',
    'SPRECOGNIZERSTATUS', '_RemotableHandle', 'SPEI_SOUND_END',
    'eLEXTYPE_PRIVATE14', 'SRAExport', 'SPRST_ACTIVE',
    'SPVPRI_NORMAL', 'eLEXTYPE_PRIVATE4', 'SAFT16kHz16BitStereo',
    'ISpeechFileStream', 'SPXRO_Alternates_SML', 'SPBOOKMARKOPTIONS',
    'DISPID_SVGetAudioOutputs', 'SPEI_RECO_OTHER_CONTEXT',
    'SpSharedRecoContext', 'DISPID_SpeechPhraseRule',
    'SVSFPersistXML', 'DISPID_SVStatus', 'SAFT48kHz8BitMono',
    'ISpStreamFormatConverter', 'SPVISEMES', 'SP_VISEME_16',
    'SpeechDataKeyLocation', 'DISPID_SVSyncronousSpeakTimeout',
    'SGDSActiveWithAutoPause', 'SECHighConfidence',
    'ISpeechXMLRecoResult', 'STCLocalServer', 'DISPID_SLPsItem',
    'ISpeechPhraseAlternates', 'DISPID_SPEPronunciation',
    'SPFM_OPEN_READWRITE', 'eLEXTYPE_RESERVED7', 'DISPID_SGRSTWeight',
    'SVP_2', 'DISPID_SRCBookmark', 'DISPID_SVAudioOutputStream',
    'SPEI_UNDEFINED', 'DISPID_SDKGetBinaryValue', 'SAFT16kHz8BitMono',
    'SAFTADPCM_8kHzStereo', 'DISPID_SAEventHandle',
    'DISPID_SRRAudioFormat', 'SPCS_ENABLED', 'SpWaveFormatEx',
    'SAFTCCITT_uLaw_22kHzMono', 'SDKLLocalMachine',
    'DISPID_SRCResume', 'SPCT_DICTATION',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SVEStreamEnd',
    'SP_VISEME_19', 'SPRST_NUM_STATES', 'DISPID_SPPEngineConfidence',
    'SAFT48kHz8BitStereo', 'SPEI_SOUND_START', 'ISpProperties',
    'DISPID_SRRDiscardResultInfo',
    'SpeechGrammarRuleStateTransitionType', 'SPSHORTCUTPAIRLIST',
    'SREAdaptation', 'DISPID_SPEEngineConfidence', 'DISPID_SBSWrite',
    'SPPS_Unknown', 'DISPID_SpeechPhraseBuilder',
    'SpeechVisemeFeature', 'SP_VISEME_6', 'ISpeechLexiconWords',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPRFirstElement',
    'IEnumString', 'SDTAlternates', 'SLTApp', 'SAFT22kHz16BitMono',
    'SGSEnabled', 'SSFMOpenForRead', 'ISpeechGrammarRules',
    'SpeechGrammarTagWildcard', 'SVP_7', 'DISPID_SVGetAudioInputs',
    'DISPID_SGRAttributes', 'DISPID_SpeechObjectToken',
    'ISpRecoContext', 'DISPIDSPRG', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SVEPhoneme', 'IInternetSecurityMgrSite',
    'DISPID_SpeechPhraseProperties', 'SpResourceManager',
    'SpeechVoiceEvents', 'SPEI_FALSE_RECOGNITION',
    'SPRS_ACTIVE_USER_DELIMITED', '_SPAUDIOSTATE',
    'DISPID_SMSALineId', 'DISPID_SpeechPhraseReplacements',
    'eLEXTYPE_PRIVATE19', 'DISPID_SRAudioInputStream',
    'DISPID_SGRClear', 'SPEI_START_SR_STREAM', 'SVP_8',
    'DISPID_SRSCurrentStreamNumber', 'ISpeechPhraseRule',
    'DISPID_SVSLastBookmarkId', 'eLEXTYPE_PRIVATE13',
    'STSF_FlagCreate', 'DISPID_SOTRemoveStorageFileName',
    'SP_VISEME_11', 'DISPID_SPRuleEngineConfidence',
    'eLEXTYPE_LETTERTOSOUND', 'SGRSTTWildcard', 'DISPID_SDKOpenKey',
    'DISPID_SpeechRecognizerStatus', 'SGDSActiveUserDelimited',
    'DISPID_SRRAudio', 'DISPID_SABIMinNotification',
    'DISPID_SVEViseme', 'SSTTDictation', 'ISpObjectToken',
    'SpeechStreamSeekPositionType', 'SAFTDefault',
    'SpeechBookmarkOptions', 'SPCT_SLEEP', 'ISpeechPhraseElement',
    'DISPID_SRCRetainedAudioFormat', 'SPPS_Verb',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SBSSeek',
    'SPCATEGORYTYPE', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SVEventInterests', 'SpeechPartOfSpeech',
    'DISPID_SAStatus', 'DISPID_SRRPhraseInfo',
    'DISPID_SGRAddResource', 'ISpRecoGrammar', 'SVP_18',
    'eLEXTYPE_APP', 'ISpeechRecoGrammar', 'SSSPTRelativeToStart',
    'ISpeechAudioBufferInfo', 'DISPID_SRGCmdSetRuleState',
    'SAFTCCITT_ALaw_8kHzMono', 'SVSFParseSsml', 'DISPID_SDKCreateKey',
    'ISpRecoGrammar2', 'DISPID_SDKEnumKeys', 'STSF_CommonAppData',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRRAlternates', 'SP_VISEME_2',
    'SPLEXICONTYPE', 'DISPID_SPPConfidence',
    'SpeechRetainedAudioOptions', 'SVEBookmark', 'SITooFast',
    'eLEXTYPE_PRIVATE17', 'SDTReplacement', 'SPSVerb',
    'DISPID_SRRSaveToMemory', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRGCommit', 'DISPID_SOTCategory', 'SP_VISEME_13',
    'SPINTERFERENCE_TOOLOUD', 'SREPropertyNumChange', 'SGDSActive',
    'eLEXTYPE_PRIVATE7', 'SRSActive', 'SVESentenceBoundary',
    'SVEEndInputStream', 'SVP_1', 'ISpRecognizer3',
    'eLEXTYPE_PRIVATE2', 'DISPID_SPEAudioSizeTime',
    'DISPID_SLGetWords', 'eLEXTYPE_RESERVED6', 'SPPHRASEPROPERTY',
    'SVSFUnusedFlags', 'SPSERIALIZEDPHRASE', 'DISPID_SLWType',
    'SpeechSpecialTransitionType', 'SPEI_MAX_TTS', 'SGDisplay',
    'ISpeechPhoneConverter', 'DISPID_SLPsCount',
    'SPSEMANTICERRORINFO', 'SAFT32kHz16BitMono', 'DISPID_SLPSymbolic',
    'DISPID_SVVolume', 'ISpPhrase', 'SVP_17', 'SPAS_RUN',
    'DISPID_SASCurrentDevicePosition', 'SVSFlagsAsync',
    'DISPID_SRRRecoContext', 'DISPID_SVResume',
    'DISPID_SPEDisplayText', 'SLOStatic', 'SRTEmulated', 'SWTDeleted',
    'DISPID_SVSInputSentencePosition', 'SPSMF_SAPI_PROPERTIES',
    'SPRECOCONTEXTSTATUS', 'SGDSInactive', 'SLODynamic',
    'DISPID_SpeechVoice', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SGRAddState', 'SDA_No_Trailing_Space', 'SPEVENTENUM',
    'SASStop', 'SPRS_ACTIVE', 'DISPID_SLWsCount', 'SAFT24kHz8BitMono',
    'DISPID_SRCEEnginePrivate', 'SpeechTokenKeyUI',
    'DISPID_SLPPhoneIds', 'ISpeechObjectTokens',
    'DISPIDSPTSI_SelectionOffset', 'SpInprocRecognizer',
    'STSF_AppData', 'DISPID_SPIEngineId', 'SpeechAudioProperties',
    'DISPID_SPIProperties', 'SPCT_SUB_COMMAND', 'SSFMCreateForWrite',
    'SPTEXTSELECTIONINFO', 'DISPID_SPAsCount', 'SVSFNLPSpeakPunc',
    'SECFIgnoreWidth', 'ISpeechRecognizerStatus',
    'SRTExtendableParse', 'SVSFPurgeBeforeSpeak',
    'SAFT12kHz8BitStereo', 'SpShortcut', 'SpPhoneConverter',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPPS_Noncontent',
    'ISequentialStream', 'SVSFParseSapi', 'DISPID_SVPriority',
    'SDTLexicalForm', 'DISPID_SpeechVoiceStatus', 'SASPause',
    'DISPID_SRCEBookmark', 'SPBO_NONE', 'SVF_Emphasis',
    'SPPS_RESERVED3', 'SPINTERFERENCE_NOSIGNAL', 'SVP_16',
    'DISPID_SGRSTs_NewEnum', 'SP_VISEME_7', 'eLEXTYPE_PRIVATE9',
    'SAFT8kHz8BitMono', 'ISpeechMemoryStream',
    'DISPID_SWFEBlockAlign', 'DISPID_SRGetRecognizers', 'SVP_19',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpeechMMSysAudio',
    'Speech_Max_Pron_Length', 'ISpMMSysAudio',
    'DISPID_SpeechPhraseInfo', 'SPWAVEFORMATTYPE',
    'DISPID_SLRemovePronunciation', 'eLEXTYPE_PRIVATE18',
    'DISPID_SOTSetId', 'DISPID_SVEAudioLevel', 'SPSTREAMFORMATTYPE',
    'SPWF_INPUT', 'DISPID_SPRuleParent', 'DISPID_SVEBookmark',
    'SAFTADPCM_11kHzStereo', 'DISPID_SVEWord',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SRState',
    'SWPKnownWordPronounceable', 'DISPID_SOTCSetId',
    'SPEI_SR_RETAINEDAUDIO', 'ISpeechPhraseReplacement',
    'DISPID_SRSetPropertyString', 'SPAUDIOOPTIONS',
    'SAFTADPCM_44kHzStereo', 'SAFT48kHz16BitMono',
    'Speech_StreamPos_RealTime', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SLGetGenerationChange', 'SpeechVoiceSpeakFlags',
    'SAFT11kHz8BitMono', 'SpMemoryStream', 'DISPID_SRIsUISupported',
    'SDTPronunciation', 'SRTAutopause', 'SAFTADPCM_22kHzStereo',
    'SPWF_SRENGINE', 'DISPID_SLPType', 'DISPID_SGRSTPropertyValue',
    'SAFT11kHz16BitStereo', 'DISPID_SGRSTsCount',
    'ISpObjectTokenCategory', 'DISPID_SVSCurrentStreamNumber',
    'SVP_10', 'DISPID_SOTsItem', 'SAFTExtendedAudioFormat',
    'SREBookmark', 'DISPID_SVSLastBookmark', 'DISPID_SDKGetlongValue',
    'SREPropertyStringChange', 'SP_VISEME_14', 'SPEI_PHRASE_START',
    'DISPID_SRCEFalseRecognition', 'SASRun', 'SPPS_RESERVED1',
    'SECFEmulateResult', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SpeechCustomStream', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SDKSetStringValue', 'SITooQuiet', 'SPWORDPRONOUNCEABLE',
    'DISPID_SDKEnumValues', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SpeechPhraseElement', 'DISPID_SGRSTNextState',
    'DISPID_SRSCurrentStreamPosition', 'SpeechRegistryUserRoot',
    'DISPID_SRCVoicePurgeEvent', 'SVSFDefault', 'SpMMAudioEnum',
    'DISPID_SRGCmdLoadFromObject', 'SRESoundStart',
    'DISPID_SpeechLexiconProns', 'DISPID_SDKDeleteKey',
    'DISPID_SRCEPhraseStart', 'SAFT44kHz16BitMono',
    'SPEI_START_INPUT_STREAM', 'DISPID_SpeechPhraseElements',
    'DISPID_SpeechDataKey', 'SPBO_AHEAD', 'DISPID_SOTCDefault',
    'SPPS_Modifier', 'DISPID_SRCEEndStream', 'SRSActiveAlways',
    'DISPID_SGRSRule', 'SpeechDiscardType',
    'SpeechGrammarTagUnlimitedDictation', 'SPEI_RESERVED5',
    'SPLOADOPTIONS', 'SP_VISEME_4', 'SPPHRASEELEMENT',
    'ISpeechPhraseProperties', 'SPEI_PHONEME', 'SpeechLexiconType',
    'DISPID_SRCState', 'Speech_Max_Word_Length',
    'SECNormalConfidence', 'SRTReSent', 'SVP_0', 'DISPID_SGRSTType',
    'SpeechPropertyLowConfidenceThreshold', 'SPINTERFERENCE_TOOFAST',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SOTId', 'LONG_PTR',
    'SPEI_SR_AUDIO_LEVEL', 'SPEI_TTS_BOOKMARK', 'SPFM_CREATE_ALWAYS',
    'SAFT44kHz16BitStereo', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SVSPhonemeId',
    'DISPID_SRCreateRecoContext', 'DISPID_SVSpeakStream',
    'DISPID_SPRuleId', 'SPDKL_CurrentUser', 'SPAS_CLOSED',
    'DISPID_SPPName', 'SPLO_STATIC', 'SDTProperty',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SOTCGetDataKey',
    'DISPID_SpeechAudio', 'SPEI_MAX_SR', 'DISPID_SPAs_NewEnum',
    'DISPID_SLAddPronunciation', 'SREPhraseStart', 'SDTRule',
    'DISPID_SpeechMMSysAudio', 'SPSHT_Unknown', 'DISPID_SLWsItem',
    'DISPID_SRRSetTextFeedback', 'SpeechGrammarTagDictation',
    'DISPID_SPEsCount', 'DISPID_SRRTTickCount', 'DISPID_SPPId',
    'DISPID_SVSInputWordPosition', 'DISPID_SVSInputSentenceLength',
    'DISPID_SAFGuid', 'SPGS_DISABLED', 'DISPID_SpeechLexiconWord',
    'DISPID_SRSetPropertyNumber', 'SVP_20', 'SDKLDefaultLocation',
    'SpeechTokenShellFolder', 'SpeechTokenContext', 'SPAUDIOSTATE',
    'DISPID_SOTRemove', 'DISPID_SRCRetainedAudio', 'SPVPRI_OVER',
    'SRADynamic', 'ISpNotifyTranslator', 'SPRST_INACTIVE',
    'SVEViseme', 'SPWORDPRONUNCIATIONLIST', 'DISPID_SPIAudioSizeTime',
    'DISPID_SOTs_NewEnum', 'SPADAPTATIONRELEVANCE',
    'SECFNoSpecialChars', 'DISPID_SpeechPhraseProperty',
    'DISPID_SPIElements', 'SpeechPropertyHighConfidenceThreshold',
    'SFTInput', 'SpMMAudioIn', 'SpSharedRecognizer',
    'SPSNotOverriden', 'UINT_PTR', 'SpeechPropertyAdaptationOn',
    'DISPID_SRStatus', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SRGetPropertyString', 'SINoise',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRGIsPronounceable', 'DISPID_SGRsDynamic',
    'SAFT32kHz8BitMono', 'SPVOICESTATUS', 'SPINTERFERENCE',
    'SVEAudioLevel', 'SPBO_PAUSE', 'DISPID_SABufferInfo',
    'DISPID_SpeechGrammarRuleStateTransitions', 'eLEXTYPE_RESERVED9',
    'DISPID_SVAudioOutput', 'SpeechCategoryRecoProfiles',
    'DISPID_SRGReset', 'DISPID_SRRSpeakAudio', 'SPEI_TTS_PRIVATE',
    'DISPID_SPRulesCount', 'SPEI_RESERVED2',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SAFType',
    'SFTSREngine', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'ISpEventSink', 'DISPID_SVEEnginePrivate',
    'SpeechRecognitionType', 'ISpeechGrammarRuleState',
    'ISpRecoResult', 'SpeechDisplayAttributes',
    'SpeechCategoryAppLexicons', 'SP_VISEME_9', 'SpAudioFormat',
    'DISPID_SLPs_NewEnum', 'SPGRAMMARWORDTYPE', 'SPBO_TIME_UNITS',
    'SP_VISEME_3', 'Speech_StreamPos_Asap', 'SPLO_DYNAMIC',
    'SPEI_RESERVED3', 'DISPID_SVAlertBoundary'
]

_check_version('1.1.14', 1680581703.670743)
