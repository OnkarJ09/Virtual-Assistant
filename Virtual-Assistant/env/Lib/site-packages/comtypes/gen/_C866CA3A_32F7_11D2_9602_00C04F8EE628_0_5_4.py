...
__all__ = [
    'SAFTCCITT_uLaw_44kHzMono', 'SPPARTOFSPEECH', 'SPEI_SOUND_END',
    'SVP_15', 'SPGRAMMARSTATE', 'ISpStreamFormat',
    'ISpeechLexiconWords', 'DISPID_SPRuleId', 'ISpRecoContext',
    'SpeechCategoryAudioOut', 'SpPhraseInfoBuilder', 'ISpNotifySink',
    'DISPID_SOTsCount', 'STCRemoteServer', 'DISPID_SRCEEnginePrivate',
    'DISPID_SPELexicalForm', 'SSTTDictation',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVEBookmark',
    'DISPID_SGRSTsItem', 'SDA_Consume_Leading_Spaces', 'SPCT_SLEEP',
    'DISPID_SPPs_NewEnum', 'DISPID_SLPsItem',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPFILEMODE', 'SREPhraseStart',
    'SpMMAudioIn', 'DISPID_SLWsItem', 'SGRSTTRule',
    'eLEXTYPE_RESERVED6', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SFSClose', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'Speech_Max_Pron_Length', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SBSFormat',
    'DISPID_SRCESoundStart', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SLGenerationId', 'DISPID_SpeechRecoContext',
    'DISPID_SPCPhoneToId', 'DISPID_SpeechObjectTokenCategory',
    'SGRSTTTextBuffer', 'SPAS_PAUSE', 'DISPID_SpeechCustomStream',
    'SpeechRegistryUserRoot', 'SPPS_Modifier', 'SpeechVoicePriority',
    'SPRST_ACTIVE_ALWAYS', 'SASStop', 'SPXRO_SML', 'SVSFParseMask',
    'DISPID_SWFEBlockAlign', 'DISPID_SRIsUISupported', 'SRCS_Enabled',
    'SPEI_RESERVED3', 'DISPID_SpeechVoice', 'ISpObjectWithToken',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SASCurrentSeekPosition', 'SAFT44kHz8BitMono',
    'SpeechRuleState', 'SP_VISEME_0', 'SP_VISEME_5', 'SPWF_INPUT',
    'SP_VISEME_16', 'SVEStartInputStream', 'SP_VISEME_10',
    'DISPID_SpeechPhraseInfo', 'SRADefaultToActive', 'SPPS_RESERVED2',
    'SDTDisplayText', 'SAFTCCITT_ALaw_8kHzMono', 'SPDKL_LocalMachine',
    'SAFT44kHz16BitMono', 'ISpeechPhraseProperties',
    'SPEI_SR_PRIVATE', 'SPCT_SUB_DICTATION', 'SpAudioFormat',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SLPType',
    'DISPID_SVSLastBookmark', 'SPWT_LEXICAL',
    'DISPID_SpeechPhraseAlternates', 'SP_VISEME_18', 'SGLexical',
    'ISpeechAudioStatus', 'ISpeechRecoResult2', 'SVSFNLPMask',
    'SPPHRASEREPLACEMENT', 'DISPID_SVEVoiceChange',
    'DISPID_SRSetPropertyString', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SDKCreateKey', 'SRERequestUI', 'DISPID_SOTCDefault',
    'DISPID_SVEBookmark', 'SDKLCurrentConfig', 'ISpRecoCategory',
    'DISPID_SMSAMMHandle', 'DISPID_SRGDictationSetState',
    'SAFT16kHz8BitStereo', 'ISpeechXMLRecoResult',
    'DISPID_SMSALineId', 'Speech_StreamPos_RealTime',
    'SPEI_UNDEFINED', 'SAFTCCITT_uLaw_8kHzMono', 'SVP_2',
    'SGSEnabled', 'DISPID_SRRTimes', 'SGRSTTWord',
    'IInternetSecurityMgrSite', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SLWPronunciations', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRCERequestUI', 'SAFT22kHz8BitStereo', 'SPGS_DISABLED',
    'DISPID_SRRAudioFormat', 'SECFIgnoreWidth', 'DISPID_SRGetFormat',
    'DISPID_SDKDeleteKey', 'DISPID_SRCRecognizer',
    'DISPID_SRCCreateGrammar', 'SpeechStreamSeekPositionType',
    'SRAORetainAudio', 'SVEViseme', 'DISPID_SDKGetlongValue',
    'SpeechAddRemoveWord', 'SPPHRASEPROPERTY',
    'DISPID_SRRSetTextFeedback', 'ISpeechObjectToken',
    'DISPID_SpeechLexicon', 'eLEXTYPE_PRIVATE19', 'SVP_3',
    'SREStreamEnd', 'SpeechTokenIdUserLexicon',
    'DISPID_SRGetPropertyNumber', 'SECHighConfidence',
    'DISPID_SPPFirstElement', 'SPCS_ENABLED',
    'DISPID_SPEActualConfidence', 'SpNotifyTranslator',
    'DISPID_SPRsItem', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SPAPhraseInfo', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRGReset', 'SPFM_CREATE_ALWAYS', 'SINoSignal',
    '__MIDL_IWinTypes_0009', 'DISPID_SRCRequestedUIType',
    'eLEXTYPE_PRIVATE16', 'SASClosed', 'ISpeechDataKey', 'SPPS_Noun',
    'DISPID_SPRsCount', 'SpeechRunState', 'SVP_16',
    'SpeechMicTraining', 'SPDKL_DefaultLocation', 'SPWORDTYPE',
    'DISPID_SBSWrite',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPAsCount', 'ISpeechRecoResult',
    'DISPID_SOTCreateInstance', 'SPSHORTCUTPAIRLIST', 'SPRST_ACTIVE',
    'SpeechAudioVolume', 'DISPID_SOTDataKey', 'DISPIDSPTSI',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISequentialStream',
    'SP_VISEME_7', 'DISPID_SPEsCount', 'SVP_13',
    'SECNormalConfidence', 'SVF_None', 'SPSInterjection',
    'SAFT44kHz16BitStereo', 'DISPID_SpeechGrammarRuleStateTransition',
    'SVP_4', 'DISPID_SpeechDataKey', 'DISPID_SVSLastResult',
    'DISPID_SVEStreamStart', 'DISPID_SRGCmdSetRuleIdState',
    'SVEEndInputStream', 'DISPID_SPPEngineConfidence',
    'SPSHT_NotOverriden', 'DISPID_SVEWord',
    'DISPID_SRSetPropertyNumber', 'DISPID_SLAddPronunciation',
    'SPSMF_UPS', 'SpeechDiscardType', 'ISpeechVoiceStatus',
    'eLEXTYPE_PRIVATE8', 'SREPropertyNumChange', 'SPVISEMES',
    'SpeechPropertyResourceUsage', 'SREAllEvents', 'DISPID_SPCLangId',
    'ISpDataKey', 'DISPID_SDKDeleteValue', 'SVPOver',
    'DISPID_SpeechLexiconWords', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SRGId', 'SPDKL_CurrentConfig', 'SAFT16kHz16BitStereo',
    'SAFT48kHz16BitStereo', 'DISPID_SRCCmdMaxAlternates',
    'SWPUnknownWordUnpronounceable', 'SpeechVisemeFeature',
    'SpInProcRecoContext', 'SpInprocRecognizer',
    'DISPID_SVSLastBookmarkId', 'STCInprocServer', 'SRTReSent',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPBINARYGRAMMAR', 'ISpeechAudio',
    'DISPID_SGRSTText', 'DISPID_SVVoice', 'SpeechAllElements',
    'DISPID_SRCEPropertyNumberChange', 'LONG_PTR', 'SVSFIsXML',
    'SVSFPurgeBeforeSpeak', 'SDTPronunciation',
    'DISPID_SpeechAudioStatus', 'DISPID_SPEEngineConfidence',
    'SFTInput', 'SPSSuppressWord', 'SPSTREAMFORMATTYPE',
    'DISPID_SGRSTransitions', 'DISPID_SRGIsPronounceable',
    'ISpRecoContext2', 'DISPID_SRSNumberOfActiveRules',
    'SpeechAudioFormatType', 'SAFT24kHz16BitStereo',
    'SGPronounciation', 'SVP_21', 'DISPID_SOTRemoveStorageFileName',
    'eLEXTYPE_RESERVED9', 'SAFT16kHz8BitMono', 'SPAS_RUN',
    'SWPUnknownWordPronounceable', 'DISPID_SpeechObjectTokens',
    'DISPID_SWFEFormatTag', 'SDKLCurrentUser', 'DISPID_SLWType',
    'SREAdaptation', 'SSTTWildcard', 'ISpPhoneticAlphabetConverter',
    'DISPID_SGRClear', 'SpeechTokenContext', 'SpNullPhoneConverter',
    'SAFT12kHz8BitMono', 'SpMMAudioOut', 'SPSERIALIZEDRESULT',
    'DISPID_SVESentenceBoundary', 'ISpeechMemoryStream',
    'IInternetSecurityManager', 'ISpeechVoice', 'ISpeechObjectTokens',
    'eWORDTYPE_ADDED', 'DISPID_SPAsItem', 'DISPID_SLWsCount',
    'STSF_AppData', 'DISPID_SAStatus', 'ISpeechLexiconPronunciations',
    'DISPID_SGRs_NewEnum', 'SPRECOSTATE', 'SP_VISEME_11',
    'SPPS_SuppressWord', 'SVSFParseAutodetect',
    'SpeechEmulationCompareFlags', 'SSFMCreateForWrite',
    'SPRECORESULTTIMES', 'SpeechWordType', 'SPWORD',
    'eLEXTYPE_PRIVATE15', 'SPEI_START_SR_STREAM', 'DISPID_SRGRules',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPRNumberOfElements',
    'DISPID_SVEventInterests', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SPPNumberOfElements', 'SRTEmulated',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SOTCategory',
    'SREFalseRecognition', 'SRSActive', 'DISPID_SWFEExtraData',
    'SPPHRASERULE', 'SpPhoneticAlphabetConverter', 'SPAUDIOSTATE',
    'SLTUser', 'DISPID_SRCPause', 'DISPID_SOTRemove', 'SDTAudio',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRGCmdSetRuleState',
    'SPFM_OPEN_READWRITE', 'eLEXTYPE_PRIVATE4', 'SVP_17',
    'DISPID_SRRecognizer', 'eLEXTYPE_LETTERTOSOUND',
    'SAFT24kHz8BitStereo', 'SDA_Two_Trailing_Spaces',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPIElements',
    'DISPID_SLPLangId', 'SpeechRecoContextState',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFT22kHz16BitMono',
    'SASPause', 'SRATopLevel', 'SREPrivate', 'SAFTADPCM_22kHzStereo',
    'DISPID_SpeechFileStream', 'DISPID_SASState',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPRulesCount',
    'DISPID_SGRAttributes', 'SpeechPropertyResponseSpeed', 'SVPAlert',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SPRuleFirstElement',
    'DISPID_SpeechXMLRecoResult', 'SpeechBookmarkOptions',
    'DISPID_SRRGetXMLResult', 'SVESentenceBoundary', 'SVSFlagsAsync',
    'DISPID_SRRTLength', 'DISPID_SOTCId', 'DISPID_SRCEAdaptation',
    'ISpeechRecognizer', 'DISPID_SOTSetId',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SGRsAdd',
    'DISPID_SOTs_NewEnum', 'SpeechTokenKeyUI',
    'SpeechDictationTopicSpelling', 'SpeechEngineProperties',
    'ISpeechPhraseRules', 'SpeechFormatType',
    'SpTextSelectionInformation', 'DISPID_SMSGetData',
    'SAFT22kHz8BitMono', 'SPVPRI_NORMAL', 'ISpObjectToken',
    'SPVPRIORITY', 'SRSEDone', 'SITooQuiet', 'SP_VISEME_6',
    'DISPID_SpeechPhraseReplacements', 'eLEXTYPE_PRIVATE6',
    'SpObjectTokenCategory', 'DISPID_SPIGrammarId',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SPRuleParent',
    'DISPID_SPRuleChildren', 'DISPID_SVRate', 'ISpLexicon',
    'SpeechDataKeyLocation', 'SVEAudioLevel', '_SPAUDIOSTATE',
    'SPPS_LMA', 'ISpeechTextSelectionInformation',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRRPhraseInfo',
    'SPAR_Medium', 'SpeechLexiconType', 'DISPID_SPPsItem',
    'DISPID_SOTCSetId', 'SP_VISEME_4', 'DISPID_SPRuleName',
    'DISPID_SVDisplayUI', 'SpLexicon', 'eLEXTYPE_PRIVATE20',
    'SINoise', 'STCLocalServer', 'SpeechRegistryLocalMachineRoot',
    'SPPS_NotOverriden', 'DISPID_SPIStartTime', 'SpeechAudioState',
    'SRAExport', 'IEnumSpObjectTokens', 'ISpeechLexicon',
    'DISPID_SRSClsidEngine', 'SAFT11kHz16BitStereo',
    'DISPID_SOTCEnumerateTokens', 'ISpeechLexiconPronunciation',
    'SVP_12', 'SAFTCCITT_ALaw_22kHzMono', 'SAFTCCITT_uLaw_22kHzMono',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SRAudioInput', 'UINT_PTR',
    'ISpRecoGrammar2', 'SAFT22kHz16BitStereo',
    'DISPID_SGRSTPropertyName', 'SpeechGrammarTagWildcard',
    '_RemotableHandle', 'SREStateChange',
    'SSSPTRelativeToCurrentPosition', 'SRTStandard', 'SGSExclusive',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SpeechAudioFormat',
    'SDA_No_Trailing_Space', 'DISPID_SVSRunningState',
    'DISPID_SRGCmdLoadFromObject', 'ISpRecoGrammar',
    'DISPID_SLPPhoneIds', 'SAFT32kHz16BitMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRGState', 'DISPID_SRRAudio', 'SpMMAudioEnum',
    'ISpEventSink', 'SVP_8', 'SECFEmulateResult',
    '_ISpeechRecoContextEvents', 'DISPID_SGRInitialState',
    'SPEI_END_SR_STREAM', 'eLEXTYPE_USER', 'SpResourceManager',
    'SASRun', 'DISPID_SRCRetainedAudio', 'DISPID_SVEViseme',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRCreateRecoContext',
    'SPAS_CLOSED', 'DISPID_SPERequiredConfidence', 'SVP_10',
    'DISPID_SPIAudioSizeBytes', 'SRARoot', 'DISPID_SPAs_NewEnum',
    'SVSFIsNotXML', 'DISPID_SVSInputSentencePosition', 'SVF_Emphasis',
    'SPSEMANTICERRORINFO', 'DISPID_SRRSpeakAudio',
    'SDA_One_Trailing_Space', 'SPEI_TTS_PRIVATE', 'SPCT_DICTATION',
    'SPEI_REQUEST_UI', 'SVEPrivate', 'eLEXTYPE_PRIVATE2',
    'SP_VISEME_3', 'SpeechCategoryPhoneConverters', 'DISPID_SGRsItem',
    'DISPID_SLGetPronunciations', 'DISPID_SpeechRecognizer',
    'SpeechVoiceSpeakFlags', 'DISPID_SPRuleEngineConfidence',
    'SAFTGSM610_44kHzMono', 'SFTSREngine', 'ISpNotifySource',
    'SPSFunction', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SLWs_NewEnum', 'DISPID_SDKSetLongValue',
    'DISPID_SVSpeakCompleteEvent', 'ISpPhoneticAlphabetSelection',
    'DISPID_SABufferInfo', 'DISPID_SPEAudioSizeBytes',
    'eLEXTYPE_RESERVED4', 'eLEXTYPE_PRIVATE18',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVPause',
    'SVSFPersistXML', 'DISPID_SPCIdToPhone', 'SpSharedRecognizer',
    'SPGS_EXCLUSIVE', 'SDTLexicalForm', 'DISPID_SpeechVoiceStatus',
    'SPEI_SENTENCE_BOUNDARY', 'SAFTDefault', 'SAFT8kHz16BitStereo',
    'DISPID_SVSVisemeId', 'SPPS_RESERVED1', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPEPronunciation', 'DISPID_SABIEventBias',
    'SpeechInterference', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRRTTickCount',
    'DISPID_SGRsCount', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SOTsItem', 'DISPID_SVGetAudioOutputs',
    'DISPID_SVSInputSentenceLength', 'SAFTNoAssignedFormat',
    'ISpeechRecoResultTimes', 'SAFT12kHz16BitMono', 'SINone', 'SVP_5',
    'SPFM_NUM_MODES', 'DISPID_SVSyncronousSpeakTimeout',
    'SAFTADPCM_8kHzMono', 'DISPID_SRCEEndStream',
    'ISpeechPhraseReplacements', 'SpeechGrammarWordType',
    'DISPID_SPRuleConfidence', 'DISPID_SGRName', 'SGRSTTWildcard',
    'SpObjectToken', 'SSFMOpenReadWrite',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SGRAddResource',
    'DISPID_SRGCommit', 'DISPID_SPRFirstElement', 'SPEI_RESERVED1',
    'DISPID_SLGetGenerationChange', 'SpCustomStream',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechRecoGrammar',
    'SPEVENTENUM', 'SRESoundStart', 'eLEXTYPE_MORPHOLOGY',
    'SpeechLoadOption', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpFileStream', 'DISPID_SRCState', 'SpeechCategoryAudioIn',
    'SDKLDefaultLocation', 'DISPID_SVResume',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPPS_RESERVED4',
    'DISPID_SVPriority', 'ISpeechPhraseAlternates',
    'DISPID_SPACommit', 'SAFT44kHz8BitStereo', 'SVEPhoneme',
    'SAFTText', 'SpeechCategoryAppLexicons',
    'DISPID_SpeechRecoResult', 'DISPID_SCSBaseStream',
    'SVSFUnusedFlags', 'DISPID_SVAudioOutputStream', 'SP_VISEME_2',
    'DISPID_SRGCmdLoadFromMemory', 'SGDSActiveUserDelimited',
    'DISPID_SGRSAddSpecialTransition', 'SPEI_TTS_BOOKMARK',
    'ISpeechGrammarRuleState', 'IEnumString', 'DISPID_SLWWord',
    'SPEI_MAX_SR', 'SpeechRecoEvents', 'DISPID_SRCEStartStream',
    'SRERecognition', 'ISpProperties', '_ISpeechVoiceEvents',
    'ISpeechAudioFormat', 'DISPID_SPARecoResult',
    'DISPID_SDKGetBinaryValue', 'DISPID_SDKEnumKeys',
    'SpeechRetainedAudioOptions', 'ISpeechPhraseReplacement',
    'SpeechVoiceEvents', 'STSF_LocalAppData',
    'DISPID_SVIsUISupported', 'DISPID_SRCResume', 'SPEVENTSOURCEINFO',
    'DISPID_SGRSTPropertyId', 'DISPID_SLPsCount',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SPIEngineId',
    'DISPID_SPIProperties', 'SPFM_OPEN_READONLY', 'SGDSActive',
    'SPBOOKMARKOPTIONS', 'ISpAudio', 'SPSHT_EMAIL',
    'SAFTCCITT_uLaw_11kHzMono', 'SAFT12kHz16BitStereo',
    'DISPID_SRStatus', 'ISpeechWaveFormatEx', 'SpSharedRecoContext',
    'ISpRecognizer2', 'SpeechAudioFormatGUIDWave',
    'SPEI_VOICE_CHANGE', 'SECFDefault', 'DISPID_SPEDisplayAttributes',
    'DISPID_SpeechPhraseElement', 'DISPID_SBSSeek',
    'ISpeechPhraseInfoBuilder', 'SPVPRI_OVER', 'DISPID_SVGetVoices',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPIDSPTSI_ActiveOffset', 'SPCS_DISABLED',
    'DISPID_SRGDictationLoad', 'DISPID_SDKGetStringValue',
    'DISPID_SRSSupportedLanguages', 'SRAONone',
    'DISPID_SPILanguageId', 'SVSFVoiceMask',
    'DISPID_SRGetRecognizers', 'SAFT32kHz16BitStereo',
    'SpeechTokenShellFolder', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SP_VISEME_1', 'SpeechRecognizerState',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFT32kHz8BitStereo',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRRRecoContext',
    'DISPID_SVVolume', 'DISPID_SPPChildren', 'SPPS_Unknown',
    'DISPID_SGRAddState', 'DISPID_SPIEnginePrivateData',
    'SPRULESTATE', 'ISpeechCustomStream',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SPPName',
    'DISPID_SAFGetWaveFormatEx', 'ISpeechPhraseProperty',
    'SAFTADPCM_44kHzMono', 'SAFT11kHz8BitMono', 'DISPID_SOTDisplayUI',
    'SPSModifier', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SVEVoiceChange', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SABIBufferSize', 'DISPID_SOTIsUISupported',
    'DISPID_SRCEInterference', 'DISPID_SLRemovePronunciation',
    'SAFTExtendedAudioFormat', 'SPINTERFERENCE',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SASetState', 'DISPID_SpeechLexiconProns', 'SLTApp',
    'SAFTGSM610_22kHzMono', 'SVSFParseSsml', 'ISpeechPhoneConverter',
    'DISPID_SGRsCommit', 'SPLEXICONTYPE', 'SPRS_INACTIVE',
    'ISpResourceManager', 'DISPID_SpeechObjectToken', 'DISPID_SVSkip',
    'DISPID_SLPs_NewEnum', 'SECFIgnoreKanaType',
    'DISPID_SPEAudioSizeTime', 'SPTEXTSELECTIONINFO',
    'SVSFIsFilename', 'SpeechVisemeType', 'SPSUnknown',
    'DISPID_SpeechPhraseAlternate', 'SpeechWordPronounceable',
    'ISpeechObjectTokenCategory', 'SpeechGrammarState', 'SVP_6',
    'SPSNoun', 'SITooLoud', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPAUDIOSTATUS', 'SVP_18',
    'SPVOICESTATUS', 'DISPID_SAVolume', 'STCAll', 'SPSHT_OTHER',
    'SpeechDisplayAttributes', 'DISPID_SGRSTType',
    'DISPID_SASFreeBufferSpace', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRGDictationUnload', 'DISPID_SLPPartOfSpeech',
    'SPAUDIOBUFFERINFO', 'IStream', 'DISPID_SpeechPhoneConverter',
    'DISPID_SVGetProfiles', 'SDTProperty', 'SPSERIALIZEDPHRASE',
    'SP_VISEME_17', 'DISPIDSPRG', 'SpStream',
    'DISPID_SpeechPhraseProperty', 'DISPID_SpeechBaseStream',
    'ISpeechPhraseElements', 'ISpStream', 'SPRST_NUM_STATES',
    'DISPID_SVEStreamEnd', 'SPINTERFERENCE_TOOSLOW', 'SVP_0',
    'SGDSInactive', 'DISPID_SGRsDynamic', 'SAFT48kHz8BitStereo',
    'SPCATEGORYTYPE', 'SAFT11kHz16BitMono', 'SAFTGSM610_11kHzMono',
    'SSTTTextBuffer', 'DISPID_SpeechLexiconPronunciation',
    'eLEXTYPE_RESERVED7', 'SPFM_CREATE', 'DISPID_SRCESoundEnd',
    'SPPROPERTYINFO', 'DISPID_SWFEBitsPerSample',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPEI_HYPOTHESIS', 'SPEI_RESERVED6',
    'SVSFNLPSpeakPunc', 'SVP_9', 'DISPID_SPEDisplayText',
    'SPEI_MAX_TTS', 'DISPID_SGRSRule', 'DISPID_SASNonBlockingIO',
    'SPEI_RESERVED2', 'SECFIgnoreCase', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRCEBookmark', 'SpeechTokenKeyAttributes',
    'SPEI_RECOGNITION', 'eLEXTYPE_PRIVATE10', 'SAFT48kHz16BitMono',
    'DISPID_SRAudioInputStream', 'DISPID_SRSCurrentStreamPosition',
    'ISpeechRecoContext', 'SP_VISEME_13', 'SP_VISEME_20',
    'SpeechRuleAttributes', 'SVP_20', 'WAVEFORMATEX',
    'DISPID_SRGSetTextSelection', 'STCInprocHandler',
    'SpeechCategoryRecognizers', 'SPXMLRESULTOPTIONS',
    'DISPID_SRRAlternates', 'SAFTADPCM_22kHzMono',
    'SPINTERFERENCE_NONE', 'SAFT48kHz8BitMono', 'DISPID_SVEPhoneme',
    'SVP_7', 'SPXRO_Alternates_SML', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SOTGetDescription', 'DISPID_SMSSetData',
    'SVEWordBoundary', 'DISPID_SPRDisplayAttributes',
    'DISPID_SpeechMemoryStream', 'SPRST_INACTIVE',
    'DISPID_SRCBookmark', 'ISpeechPhraseInfo', 'SPPS_Interjection',
    'ISpeechPhraseElement', 'SPINTERFERENCE_NOISE',
    'DISPID_SVWaitUntilDone', 'SPWORDPRONUNCIATIONLIST', 'SPAR_High',
    'SpeechRecognitionType', 'SpeechStreamFileMode', 'SPAR_Unknown',
    'SGRSTTEpsilon', 'SpCompressedLexicon', 'SPEI_WORD_BOUNDARY',
    'eLEXTYPE_PRIVATE11', 'SSFMCreate', 'DISPID_SPISaveToMemory',
    'ISpShortcut', 'eLEXTYPE_PRIVATE12', 'SRTSMLTimeout',
    'ISpRecoResult', 'SPINTERFERENCE_NOSIGNAL', 'ISpeechMMSysAudio',
    'SPWT_DISPLAY', 'SBONone', 'SPCONTEXTSTATE', 'SAFT16kHz16BitMono',
    'DISPID_SRRTOffsetFromStart', 'SPEI_MIN_TTS', 'SVP_11',
    'SPLO_DYNAMIC', 'SWTAdded', 'SITooFast', 'SAFT24kHz16BitMono',
    'SpStreamFormatConverter', 'SP_VISEME_21', 'SSSPTRelativeToStart',
    'SPRECOGNIZERSTATUS', 'SRAImport', 'SpeechTokenKeyFiles',
    'DISPID_SFSOpen', 'DISPID_SPANumberOfElementsInResult',
    'SPWT_PRONUNCIATION', 'SAFT12kHz8BitStereo', 'ISpeechPhraseRule',
    'eLEXTYPE_RESERVED10', 'DISPID_SAFGuid', 'DISPID_SVSpeakStream',
    'SPAO_NONE', 'ISpVoice', 'SpWaveFormatEx',
    'DISPID_SRCEFalseRecognition', 'SGLexicalNoSpecialChars',
    'SWTDeleted', 'SPRS_ACTIVE', 'SpeechUserTraining',
    'SPEI_SOUND_START', 'SPDKL_CurrentUser', 'SDKLLocalMachine',
    'SpPhoneConverter', 'SpMemoryStream',
    'DISPID_SRGCmdLoadFromResource', 'ISpPhrase',
    'DISPID_SGRSTWeight', 'DISPID_SPPId',
    'DISPID_SPIAudioStreamPosition', 'SPSLMA', 'eWORDTYPE_DELETED',
    'SPVPRI_ALERT', 'SRTExtendableParse', 'DISPID_SRProfile',
    'DISPID_SAFType', 'SpeechPartOfSpeech', 'DISPID_SPIRule',
    'DISPID_SPAStartElementInResult', 'SSFMOpenForRead',
    'SRCS_Disabled', 'DISPID_SGRId', 'SGDSActiveWithAutoPause',
    'DISPID_SPPParent', 'SAFT8kHz8BitStereo', 'SAFT8kHz16BitMono',
    'SREInterference', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SVAudioOutput', 'SPEI_VISEME', 'SPEI_INTERFERENCE',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPRs_NewEnum',
    'DISPID_SOTId', 'SpeechPropertyAdaptationOn', 'SPEI_SR_BOOKMARK',
    'STSF_CommonAppData', 'DISPID_SDKOpenKey', 'SAFTADPCM_11kHzMono',
    'DISPID_SABIMinNotification', 'SREBookmark', 'SLOStatic',
    'DISPID_SRCRetainedAudioFormat', 'SpeechRecoProfileProperties',
    'SPEI_PHONEME', 'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SVEAudioLevel',
    'DISPID_SVSpeak', 'SPPS_Verb', 'eLEXTYPE_VENDORLEXICON',
    'ISpeechRecoResultDispatch', 'SVPNormal',
    'SpeechVoiceCategoryTTSRate', 'SP_VISEME_12',
    'SREPropertyStringChange', 'SPEI_RECO_OTHER_CONTEXT',
    'SVSFParseSapi', 'SPWF_SRENGINE', 'SpeechGrammarTagDictation',
    'DISPID_SOTCGetDataKey', 'DISPID_SDKSetBinaryValue',
    'SpeechSpecialTransitionType', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRIsShared', 'DISPID_SPPConfidence',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'ISpeechPhraseAlternate',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpGrammarBuilder', 'SREAudioLevel',
    'DISPID_SVEEnginePrivate', 'eLEXTYPE_PRIVATE5',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRCEventInterests',
    'DISPID_SPIGetText', 'SPPS_Noncontent', 'ISpObjectTokenCategory',
    'SpShortcut', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRRDiscardResultInfo', 'SPSNotOverriden',
    'SRSActiveAlways', 'SWPKnownWordPronounceable',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRRTStreamTime',
    'DISPID_SLGetWords', 'SPEVENT', 'eLEXTYPE_PRIVATE17',
    'DISPID_SREmulateRecognition', 'DISPID_SRSAudioStatus',
    'SRSInactiveWithPurge', 'ISpeechBaseStream',
    'ISpeechResourceLoader', 'SP_VISEME_19', 'DISPID_SRCVoice',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SpeechLexiconWord',
    'ISpXMLRecoResult', 'DISPID_SPRText',
    'DISPID_SOTMatchesAttributes', 'SVP_1', 'DISPID_SRDisplayUI',
    'DISPID_SpeechMMSysAudio', 'DISPID_SPEs_NewEnum',
    'DISPID_SpeechPhraseProperties', 'SPSEMANTICFORMAT',
    'DISPID_SPPsCount', 'SRTAutopause', 'ISpPhoneConverter',
    'DISPID_SWFEChannels', 'DISPID_SGRSTs_NewEnum',
    'ISpeechGrammarRule', 'STSF_FlagCreate', 'ISpeechGrammarRules',
    'SpVoice', 'eLEXTYPE_PRIVATE1', 'SAFT24kHz8BitMono',
    'SREHypothesis', 'SVEAllEvents', 'Speech_Max_Word_Length',
    'SpeechAudioProperties', 'SECFNoSpecialChars', 'SPRULE',
    'SPCT_COMMAND', 'SRERecoOtherContext', 'ISpPhraseAlt',
    'SPEI_ADAPTATION', 'DISPID_SGRSAddWordTransition',
    'SREStreamStart', 'SPDATAKEYLOCATION', 'DISPID_SAEventHandle',
    'SpeechPropertyLowConfidenceThreshold', 'SPWAVEFORMATTYPE',
    'DISPID_SPRules_NewEnum', 'SPEI_PHRASE_START',
    'DISPID_SADefaultFormat', 'SGSDisabled',
    'SpeechAudioFormatGUIDText', 'DISPID_SLWLangId',
    'DISPID_SpeechRecoResult2', 'SPBO_TIME_UNITS', 'SPBO_AHEAD',
    'SPSHORTCUTPAIR', 'DISPID_SVSInputWordLength', 'SPCT_SUB_COMMAND',
    'SPAS_STOP', 'DISPID_SPIRetainedSizeBytes', 'SBOPause',
    'SAFTGSM610_8kHzMono', 'SpeechTokenValueCLSID',
    'ISpeechFileStream', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRCERecognizerStateChange', 'SAFT11kHz8BitStereo',
    'SPWORDLIST', 'DISPID_SPERetainedSizeBytes', 'DISPID_SVStatus',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SpeechPhraseElements',
    'SpeechCategoryVoices', 'DISPID_SBSRead',
    'DISPID_SpeechRecoContextEvents', 'DISPIDSPTSI_ActiveLength',
    'SpeechGrammarTagUnlimitedDictation', 'eLEXTYPE_APP',
    'DISPID_SGRSTNextState', 'SDTAll', 'Speech_Default_Weight',
    'eLEXTYPE_PRIVATE7', 'SAFTTrueSpeech_8kHz1BitMono',
    'SRAInterpreter', 'SPAUDIOOPTIONS', 'DISPID_SOTGetAttribute',
    'SDTReplacement', 'ISpeechAudioBufferInfo',
    'SPADAPTATIONRELEVANCE', 'DISPID_SRCEHypothesis',
    'DISPID_SLPSymbolic', 'SGRSTTDictation', 'SDTRule',
    'SPEI_START_INPUT_STREAM', 'SpeechEngineConfidence',
    'ISpeechLexiconWord', 'SLODynamic', 'DISPID_SpeechGrammarRule',
    'SRSEIsSpeaking', 'SP_VISEME_14', 'DISPID_SRCEPhraseStart',
    'SPEI_RESERVED5', 'ISpeechRecognizerStatus',
    'DISPID_SRCEAudioLevel', 'SGDisplay', 'DISPID_SPPValue',
    'SPGS_ENABLED', 'SAFT8kHz8BitMono', 'DISPID_SGRSTsCount',
    'DISPID_SMSADeviceId', 'ISpSerializeState', 'DISPID_SRState',
    'DISPID_SpeechGrammarRules', 'ISpRecognizer', 'SRADynamic',
    'eLEXTYPE_RESERVED8', 'SPGRAMMARWORDTYPE', 'SPWORDPRONOUNCEABLE',
    'SP_VISEME_15', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SDKEnumValues', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SGRSTRule', 'SDTAlternates', 'SPPS_RESERVED3',
    'DISPID_SABufferNotifySize', 'SVSFDefault',
    'DISPID_SOTGetStorageFileName', 'SECLowConfidence',
    'DISPID_SRRSaveToMemory', 'DISPID_SPEAudioStreamOffset',
    'SPSHORTCUTTYPE', 'SITooSlow', 'SPPS_Function',
    'tagSPPROPERTYINFO', 'SPEI_SR_AUDIO_LEVEL',
    'ISpStreamFormatConverter', 'SPLOADOPTIONS',
    'DISPID_SPIAudioSizeTime', 'DISPID_SpeechAudio',
    'SPAO_RETAIN_AUDIO', 'SAFT32kHz8BitMono', 'DISPID_SPRulesItem',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRCERecognition',
    'SAFTNonStandardFormat', 'SPEI_END_INPUT_STREAM',
    'eLEXTYPE_PRIVATE3', 'SPPHRASE', 'SPEI_MIN_SR',
    'SpUnCompressedLexicon', 'SPPHRASEELEMENT',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPWORDPRONUNCIATION',
    'ISpMMSysAudio', 'DISPID_SRCSetAdaptationData', 'SPBO_PAUSE',
    'DISPID_SLAddPronunciationByPhoneIds', 'SVP_19', 'SVP_14',
    'ISpNotifyTranslator', 'SPSHT_Unknown', 'SRSInactive',
    'DISPID_SpeechWaveFormatEx',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SPEsItem', 'SVF_Stressed', 'tagSTATSTG', 'SPBO_NONE',
    'ISpeechGrammarRuleStateTransition',
    'DISPID_SVSInputWordPosition', 'DISPID_SRGetPropertyString',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SGRSTPropertyValue',
    'SP_VISEME_9', 'ISpEventSource', 'SPLO_STATIC', 'SP_VISEME_8',
    'SpeechCategoryRecoProfiles', 'DISPID_SRGRecoContext',
    'eLEXTYPE_PRIVATE14', 'DISPID_SDKSetStringValue',
    'Speech_StreamPos_Asap', 'SPSMF_SAPI_PROPERTIES',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SVGetAudioInputs', 'DISPID_SpeechPhraseRules',
    'DISPID_SVSPhonemeId', 'SPSVerb', 'SAFTADPCM_8kHzStereo',
    'DISPID_SPIReplacements', 'SSSPTRelativeToEnd',
    'DISPID_SVAlertBoundary', 'DISPID_SpeechPhraseRule', 'SPAR_Low',
    'SRESoundEnd', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SGRsCommitAndSave', 'DISPID_SGRsFindRule',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpRecognizer3'
]

_check_version('1.1.14', 1685306415.404130)
