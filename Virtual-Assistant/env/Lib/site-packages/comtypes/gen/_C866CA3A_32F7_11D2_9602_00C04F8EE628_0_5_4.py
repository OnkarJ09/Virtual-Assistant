...
__all__ = [
    'DISPID_SRGDictationSetState', 'SP_VISEME_19', 'SPAS_RUN',
    'DISPID_SpeechPhraseProperty', 'SPAS_STOP', 'SRAExport',
    'DISPID_SAEventHandle', 'SAFTADPCM_44kHzStereo',
    'ISpeechPhraseRule', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SVSFDefault', 'SPPHRASE', 'DISPID_SRCEventInterests',
    'DISPID_SPISaveToMemory', 'SITooQuiet',
    'DISPID_SpeechAudioFormat', 'DISPID_SDKGetStringValue',
    'DISPID_SRSetPropertyString', 'SDKLDefaultLocation',
    'DISPID_SRRTTickCount', 'DISPID_SRRecognizer',
    'DISPID_SVGetProfiles', 'ISpObjectToken',
    'DISPID_SOTCEnumerateTokens', 'SPSInterjection',
    'ISpeechRecoResultDispatch', 'DISPID_SRRSpeakAudio',
    'SGDSActiveUserDelimited', 'DISPID_SABufferInfo',
    'SpeechMicTraining', 'SRSActiveAlways', 'SFTSREngine',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SRADefaultToActive',
    'SpTextSelectionInformation', 'DISPID_SVEStreamStart',
    'SAFTCCITT_ALaw_8kHzMono', 'ISpeechObjectToken', 'SPAR_Unknown',
    'DISPID_SpeechLexiconPronunciation', 'SP_VISEME_15',
    'SpeechVoiceEvents', 'SAFT11kHz16BitMono',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SpeechAudioStatus',
    'SpeechTokenKeyFiles', 'DISPID_SPIEnginePrivateData', 'SITooSlow',
    'DISPID_SPERetainedStreamOffset', 'SPSModifier',
    'DISPID_SRRTLength', 'DISPID_SMSALineId', 'ISpEventSource',
    'ISpeechWaveFormatEx', 'SPEI_MIN_TTS', 'SP_VISEME_5',
    'DISPID_SPACommit', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SOTsCount', 'SVSFPersistXML', 'SAFT48kHz16BitMono',
    'DISPID_SLPPartOfSpeech', 'SVP_15', 'DISPID_SRCResume',
    'tagSTATSTG', 'SSFMCreateForWrite', 'DISPID_SLWType',
    'eLEXTYPE_PRIVATE3', 'SAFTCCITT_uLaw_8kHzMono', 'SpeechRuleState',
    'DISPID_SpeechMemoryStream', 'SRTExtendableParse',
    'SpeechAudioProperties', 'DISPID_SPPName', 'SP_VISEME_2',
    'eLEXTYPE_PRIVATE17', 'SpeechGrammarRuleStateTransitionType',
    'ISpeechLexicon', 'SPSTREAMFORMATTYPE', 'SPCS_ENABLED',
    'SAFT48kHz16BitStereo', 'DISPID_SPRules_NewEnum',
    'SSFMOpenForRead', 'DISPID_SDKSetLongValue',
    'SAFTADPCM_22kHzMono', 'DISPID_SVEViseme', 'SPGRAMMARWORDTYPE',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SLPs_NewEnum',
    'ISpGrammarBuilder', 'SpeechDataKeyLocation',
    'eLEXTYPE_PRIVATE20', 'eLEXTYPE_APP', 'SPAR_Low',
    'SPEI_INTERFERENCE', 'SPGRAMMARSTATE',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'ISpeechAudioStatus',
    'ISpRecoContext', 'SWPKnownWordPronounceable',
    'DISPID_SLGetGenerationChange', 'DISPID_SpeechGrammarRule',
    'DISPID_SOTCSetId', 'SPEI_RESERVED3', 'DISPID_SPRFirstElement',
    'SAFT11kHz8BitMono', 'DISPID_SGRsDynamic',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SLPLangId', 'SVEPrivate',
    'DISPID_SRCEStartStream', 'SPVPRIORITY', 'SPEI_RESERVED5',
    'DISPID_SVAudioOutput', 'STSF_AppData', 'DISPID_SRRSaveToMemory',
    'DISPID_SABufferNotifySize', 'SpAudioFormat', 'SPSNotOverriden',
    'DISPID_SDKSetStringValue', 'SpeechRecoContextState',
    'SVSFIsNotXML', 'SPWORDPRONOUNCEABLE', 'DISPID_SpeechRecoResult2',
    'DISPID_SLAddPronunciation', 'DISPID_SRCEInterference', 'SVP_16',
    'DISPID_SPRuleId', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechTokenValueCLSID', 'ISpeechLexiconPronunciation',
    'SRESoundEnd', 'SGPronounciation', 'SGRSTTDictation',
    'SRTStandard', 'DISPID_SLGenerationId', 'SAFT8kHz16BitMono',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'ISpRecoContext2',
    'SpStreamFormatConverter', 'SPBINARYGRAMMAR',
    'DISPID_SLRemovePronunciation', 'SAFT11kHz8BitStereo',
    'SAFT44kHz16BitMono', 'SAFTCCITT_ALaw_22kHzMono',
    'ISpeechPhraseReplacements', 'SP_VISEME_17',
    'ISpeechGrammarRuleState', 'STSF_CommonAppData',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SVSInputWordPosition', 'DISPID_SGRAddState',
    'eLEXTYPE_USER', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPAPhraseInfo',
    'SVSFIsXML', 'SWPUnknownWordPronounceable',
    'DISPID_SRGetRecognizers', 'ISpeechPhraseProperties',
    'SPEI_START_INPUT_STREAM', 'SVP_9', 'ISpShortcut',
    'SpeechSpecialTransitionType', 'SAFT22kHz8BitStereo',
    'STCInprocHandler', 'SpeechCategoryAppLexicons',
    'DISPID_SpeechDataKey', 'SP_VISEME_14',
    'DISPID_SASCurrentDevicePosition', 'SPAUDIOOPTIONS',
    'SP_VISEME_0', 'DISPID_SRCRetainedAudio', 'SAFT16kHz16BitStereo',
    'SpMMAudioEnum', 'SREHypothesis', 'DISPID_SWFEBitsPerSample',
    'SpSharedRecognizer', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SPIRule', 'DISPID_SBSRead', 'SREFalseRecognition',
    'SPSHT_Unknown', 'ISpObjectTokenCategory', 'DISPIDSPRG',
    'ISpDataKey', 'DISPID_SRSetPropertyNumber', 'SpeechWordType',
    'SPEI_TTS_PRIVATE', 'SSSPTRelativeToStart', 'eLEXTYPE_PRIVATE14',
    'SPEI_SR_AUDIO_LEVEL', 'SRSInactive', 'SPPS_RESERVED1',
    'SPSHORTCUTTYPE', 'SpeechGrammarTagWildcard',
    'SpNullPhoneConverter', 'DISPID_SpeechRecoResult',
    'SPRS_INACTIVE', 'ISpeechPhraseInfoBuilder', 'SPEI_WORD_BOUNDARY',
    'eWORDTYPE_DELETED', 'DISPID_SGRSTWeight', 'SRCS_Disabled',
    'DISPID_SRGRules', 'DISPID_SRCERequestUI', 'ISpNotifySource',
    'SRSEIsSpeaking', 'DISPID_SRSCurrentStreamPosition',
    'SpSharedRecoContext', 'SPWF_SRENGINE',
    'DISPID_SpeechVoiceStatus', 'SP_VISEME_13',
    'SAFT32kHz16BitStereo', 'ISpeechLexiconWord',
    'ISpeechRecognizerStatus', 'ISpResourceManager', 'SVP_0',
    'ISpeechGrammarRuleStateTransition', 'SPCT_SLEEP',
    'DISPID_SDKGetlongValue', 'ISpeechObjectTokenCategory',
    'SpeechPropertyResponseSpeed', 'ISpeechCustomStream',
    'DISPID_SPPId', 'DISPID_SPEEngineConfidence', 'SPSFunction',
    'STCLocalServer', 'SpeechCategoryRecoProfiles',
    'DISPID_SpeechBaseStream', 'DISPID_SVVoice', 'SPEI_SOUND_END',
    'DISPID_SRIsUISupported', 'eLEXTYPE_RESERVED8',
    'SAFTCCITT_ALaw_44kHzMono', 'SpFileStream',
    'ISpeechPhraseAlternate', 'DISPID_SVSpeakCompleteEvent',
    'SP_VISEME_4', 'SREStreamStart', 'DISPID_SVSLastResult',
    'IInternetSecurityManager', 'ISpeechPhraseElements',
    'ISpeechPhraseElement', 'DISPID_SGRName', 'SPRST_NUM_STATES',
    'SPPS_LMA', 'SAFTDefault', 'ISpStream', 'SPCONTEXTSTATE',
    'DISPID_SPIGetDisplayAttributes', 'SpeechCategoryAudioIn',
    'DISPID_SpeechCustomStream', 'SAFT16kHz16BitMono',
    'DISPID_SDKOpenKey', 'SPSUnknown', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SMSGetData', 'DISPID_SDKCreateKey', 'DISPID_SPRsItem',
    'SpPhoneticAlphabetConverter', 'DISPID_SPAStartElementInResult',
    'ISpeechResourceLoader', 'ISpPhoneConverter', 'SpLexicon',
    'ISpMMSysAudio', 'DISPID_SPIStartTime', 'SAFTGSM610_11kHzMono',
    'DISPID_SGRSTPropertyId', 'DISPID_SWFEChannels', 'SVSFParseMask',
    'SpeechCategoryAudioOut', 'SVP_19', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPEDisplayText', 'SAFTCCITT_uLaw_44kHzMono', 'SASPause',
    'DISPID_SVGetVoices', 'DISPID_SRGDictationLoad',
    'DISPID_SVSyncronousSpeakTimeout',
    'SpeechGrammarTagUnlimitedDictation', 'SpMMAudioOut',
    'DISPID_SVSLastStreamNumberQueued', 'SPDKL_CurrentUser',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SGRSTType',
    'SpeechUserTraining', 'SAFT8kHz8BitStereo',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SVGetAudioInputs',
    'SAFT32kHz16BitMono', 'DISPID_SAFSetWaveFormatEx',
    'SECLowConfidence', 'DISPID_SpeechWaveFormatEx',
    'SDA_Consume_Leading_Spaces', 'SpeechGrammarTagDictation',
    'DISPID_SRGCmdLoadFromResource', 'SAFT12kHz16BitMono',
    'eLEXTYPE_MORPHOLOGY', 'SAFTExtendedAudioFormat',
    'DISPID_SPRuleChildren', 'DISPID_SDKSetBinaryValue',
    'eLEXTYPE_PRIVATE5', 'SPEI_MAX_TTS', 'SVP_10', 'SGRSTTTextBuffer',
    'SPRECOGNIZERSTATUS', 'DISPID_SRCSetAdaptationData', 'SVPNormal',
    'SVP_13', 'SAFTText', 'DISPID_SpeechGrammarRules',
    'ISpNotifyTranslator', 'DISPID_SPEAudioSizeTime',
    'DISPID_SRCEEndStream', 'SVP_3', 'DISPID_SPEs_NewEnum',
    'DISPID_SPEAudioSizeBytes', 'SPSEMANTICFORMAT', 'DISPID_SLPsItem',
    'DISPID_SpeechPhraseInfo', 'DISPID_SRCEPhraseStart',
    'SPPS_Noncontent', 'eLEXTYPE_PRIVATE4',
    'DISPID_SpeechPhoneConverter', 'SPCS_DISABLED',
    'DISPID_SOTCDefault', 'DISPID_SVDisplayUI',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPIEngineId',
    'ISpeechMMSysAudio', 'SPAUDIOSTATE',
    'DISPID_SRGSetWordSequenceData', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRSClsidEngine', 'ISpeechRecoContext',
    'DISPID_SpeechPhraseAlternates', 'SASClosed', 'SPCT_DICTATION',
    'DISPID_SVVolume', 'SpeechDisplayAttributes',
    'DISPID_SDKDeleteKey', 'SPWAVEFORMATTYPE', 'DISPID_SPCIdToPhone',
    'SAFTCCITT_uLaw_11kHzMono', '_RemotableHandle', 'SPBO_AHEAD',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SGRSAddWordTransition', 'DISPID_SDKDeleteValue',
    'DISPID_SGRSTRule', 'DISPID_SRCCreateGrammar', 'DISPID_SAFGuid',
    'DISPID_SpeechLexiconWord', 'SBOPause', 'SPEVENT',
    'SPPS_Function', 'DISPID_SOTDisplayUI', 'DISPID_SPIGetText',
    'DISPID_SpeechVoice', 'ISpPhoneticAlphabetConverter',
    'DISPID_SGRsCommit', 'SAFT22kHz16BitMono',
    'DISPID_SGRsCommitAndSave', '_ISpeechVoiceEvents', 'SITooFast',
    'DISPID_SRRRecoContext', 'SpCustomStream', 'SVEEndInputStream',
    'SAFT16kHz8BitMono', 'DISPID_SLWPronunciations',
    'SAFTGSM610_44kHzMono', 'DISPID_SRCEHypothesis',
    'DISPID_SRCRetainedAudioFormat', 'SpeechGrammarWordType',
    'ISpRecognizer3', 'SWTDeleted', 'SPBO_PAUSE', 'SpeechAudioState',
    'DISPID_SGRSRule', 'DISPID_SBSSeek', 'SVP_11',
    'DISPID_SPAs_NewEnum', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SVPriority', 'SVP_6',
    'DISPID_SOTCGetDataKey', 'SRSEDone', 'SVEVoiceChange',
    'SVSFUnusedFlags', 'SPSHT_NotOverriden', 'SPCT_SUB_COMMAND',
    'SECFIgnoreCase', 'Speech_Max_Pron_Length', 'SGRSTTRule',
    'DISPID_SVRate', 'SAFT16kHz8BitStereo', 'SINoise',
    'SPCT_SUB_DICTATION', 'SVF_Emphasis',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SpeechPhraseBuilder',
    'SPVISEMES', 'SINoSignal', 'DISPID_SPIRetainedSizeBytes',
    'eLEXTYPE_RESERVED10', 'SPEI_RESERVED1', 'DISPID_SBSFormat',
    'SpeechPartOfSpeech', 'SPPS_RESERVED3', 'SAFTADPCM_8kHzStereo',
    'SPEI_UNDEFINED', 'Speech_StreamPos_Asap', 'ISpStreamFormat',
    'SVP_7', 'SPSLMA', 'DISPID_SGRSTNextState', 'SRERecognition',
    'DISPID_SGRSTsCount', 'SREPropertyStringChange',
    'STSF_LocalAppData', 'ISpeechRecoResultTimes', 'SpeechRunState',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SLTApp',
    'SpeechVisemeType', 'DISPID_SPRNumberOfElements',
    'SpeechDictationTopicSpelling', 'SAFTNoAssignedFormat',
    'SPSEMANTICERRORINFO', 'DISPID_SRCPause', 'SVPAlert',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRCERecognizerStateChange',
    'SpeechLexiconType', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SGRsItem', 'SpeechStreamFileMode',
    'DISPID_SVEEnginePrivate', 'SPEI_VOICE_CHANGE',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPLO_DYNAMIC',
    'DISPID_SREmulateRecognition', 'SGSDisabled', 'SPFM_CREATE',
    'ISpPhraseAlt', 'DISPID_SGRSTText', 'SpeechPropertyResourceUsage',
    'DISPID_SWFEAvgBytesPerSec', 'SSSPTRelativeToCurrentPosition',
    'ISpRecoGrammar2', 'DISPID_SPPBRestorePhraseFromMemory',
    'eLEXTYPE_VENDORLEXICON', 'SPLO_STATIC', 'DISPID_SOTCId',
    'SECHighConfidence', 'DISPID_SVResume', 'eLEXTYPE_PRIVATE7',
    'eLEXTYPE_RESERVED7', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRGCmdSetRuleState',
    'SVSFParseAutodetect', 'DISPID_SRGCmdSetRuleIdState',
    'SPFM_CREATE_ALWAYS', 'ISpeechDataKey', 'ISpRecognizer',
    'DISPID_SRGState', 'SGLexicalNoSpecialChars', 'DISPID_SPCLangId',
    'DISPID_SpeechLexicon', 'ISpAudio', 'SAFT48kHz8BitStereo',
    'SAFT24kHz8BitMono', 'SPDATAKEYLOCATION',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SAFTADPCM_8kHzMono',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SVSLastBookmarkId', 'DISPID_SASState', 'SP_VISEME_12',
    'DISPID_SOTRemoveStorageFileName',
    'ISpeechTextSelectionInformation', 'SVSFIsFilename',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SFSOpen',
    'SDA_Two_Trailing_Spaces', 'SPRST_INACTIVE', 'SPPS_Interjection',
    'DISPID_SRRTimes', 'DISPID_SPPNumberOfElements', 'DISPID_SLWWord',
    'DISPID_SRCEFalseRecognition', 'SGRSTTWildcard',
    'SPSMF_SAPI_PROPERTIES', 'SPBOOKMARKOPTIONS',
    'SAFTADPCM_11kHzStereo', 'SVEWordBoundary', 'SVSFlagsAsync',
    'SPRULESTATE', 'DISPID_SLWs_NewEnum',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SPIGrammarId',
    'ISpStreamFormatConverter', '__MIDL_IWinTypes_0009',
    'SPEI_START_SR_STREAM', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SDKEnumKeys', 'ISpRecoResult', 'DISPID_SPEsCount',
    'SPAR_Medium', 'eLEXTYPE_PRIVATE18', 'eLEXTYPE_RESERVED9',
    'DISPID_SOTSetId', 'ISpeechGrammarRules',
    'DISPID_SPIAudioStreamPosition', 'SRERequestUI',
    'DISPID_SpeechObjectTokens', 'DISPID_SPERequiredConfidence',
    'eWORDTYPE_ADDED', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPARecoResult', 'DISPID_SPRuleFirstElement',
    'DISPID_SpeechRecoContext', 'SECFNoSpecialChars',
    'ISequentialStream', 'SPVPRI_NORMAL',
    'DISPID_SpeechPhraseElement', 'ISpLexicon', 'SPINTERFERENCE',
    'SVP_1', 'STCRemoteServer', 'SPEI_PHONEME', 'DISPID_SPPValue',
    'SRCS_Enabled', 'SP_VISEME_11', 'SPGS_DISABLED',
    'DISPID_SPRs_NewEnum', 'SDTProperty', 'SPAS_CLOSED',
    'SPEI_SENTENCE_BOUNDARY', 'ISpeechLexiconPronunciations',
    'DISPID_SVStatus', 'SWTAdded', 'SRTReSent', 'SVEAudioLevel',
    'DISPID_SRCEBookmark', 'Speech_StreamPos_RealTime',
    'DISPID_SPCPhoneToId', 'SpeechAddRemoveWord',
    'SPTEXTSELECTIONINFO', 'SPAO_NONE', 'SpeechRecognitionType',
    'DISPID_SpeechRecognizer', 'SDKLCurrentUser',
    'DISPID_SVAlertBoundary', 'DISPID_SPRulesItem',
    'SPRECORESULTTIMES', 'ISpPhrase',
    'SpeechPropertyLowConfidenceThreshold', 'STCAll',
    'DISPID_SpeechVoiceEvent', 'DISPID_SFSClose', 'SPEI_ADAPTATION',
    'SAFT11kHz16BitStereo', 'DISPID_SOTMatchesAttributes',
    'SAFTCCITT_ALaw_8kHzStereo', 'SAFTCCITT_ALaw_11kHzMono',
    'SPINTERFERENCE_NONE', 'DISPID_SPIProperties',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRCEAudioLevel', 'SRATopLevel', 'SPFM_OPEN_READWRITE',
    'SpPhraseInfoBuilder', 'DISPID_SRAudioInput',
    'DISPID_SLAddPronunciationByPhoneIds', 'SLODynamic',
    'ISpeechObjectTokens', 'ISpeechPhraseInfo', 'DISPID_SPAsCount',
    'SAFT8kHz16BitStereo', 'DISPID_SVPause', 'DISPID_SMSAMMHandle',
    'SpObjectTokenCategory', 'DISPID_SRCAudioInInterferenceStatus',
    'SPPS_Modifier', 'SPPARTOFSPEECH', 'eLEXTYPE_PRIVATE19',
    'SDTPronunciation', 'SVP_12', 'SpeechCategoryPhoneConverters',
    'SSFMOpenReadWrite', 'DISPID_SOTGetStorageFileName',
    'SpeechInterference', 'DISPID_SGRClear', 'DISPID_SLPPhoneIds',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SVAudioOutputStream',
    'DISPID_SPILanguageId', 'ISpeechLexiconWords',
    'ISpeechPhraseReplacement', 'DISPID_SVSInputWordLength',
    'DISPID_SASFreeBufferSpace', 'SP_VISEME_3', 'DISPID_SGRsAdd',
    'SRAImport', 'DISPID_SRGetPropertyString', 'ISpRecoGrammar',
    'DISPID_SOTsItem', 'UINT_PTR', 'DISPID_SPPParent',
    'SpeechVoiceCategoryTTSRate', 'SVPOver', 'STSF_FlagCreate',
    'SDTAll', 'SPRST_ACTIVE', 'SpeechEngineConfidence',
    'SPEI_END_SR_STREAM', 'SDTReplacement', 'DISPID_SGRsCount',
    'SPEI_VISEME', 'DISPID_SpeechPhraseElements',
    'DISPID_SGRAttributes', 'SREAudioLevel', 'ISpeechPhraseProperty',
    'SPVOICESTATUS', 'SP_VISEME_16', 'SPADAPTATIONRELEVANCE',
    'DISPID_SLPsCount', 'DISPID_SWFEExtraData', 'SREStreamEnd',
    'DISPID_SVSInputSentenceLength', 'SPWT_PRONUNCIATION',
    'SpResourceManager', 'SPEI_FALSE_RECOGNITION', 'SpeechFormatType',
    'SPGS_ENABLED', 'SVP_8', 'SPCT_COMMAND', 'tagSPPROPERTYINFO',
    'SDTLexicalForm', 'SpeechLoadOption', 'SPWT_DISPLAY',
    'DISPID_SPEsItem', 'SVP_2', 'SpeechRecoProfileProperties',
    'eLEXTYPE_PRIVATE13', 'SpeechEmulationCompareFlags',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRGIsPronounceable', 'SAFT24kHz16BitStereo',
    'SDKLCurrentConfig', 'SPSMF_UPS', 'SpeechEngineProperties',
    'SAFT12kHz16BitStereo', 'SECFDefault',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechTokenIdUserLexicon',
    'SPRULE', 'SP_VISEME_21', 'DISPID_SPPsItem', 'DISPID_SPIElements',
    'DISPID_SOTs_NewEnum', 'SSTTTextBuffer', 'SpeechDiscardType',
    'SECFIgnoreWidth', '_ISpeechRecoContextEvents', 'DISPID_SBSWrite',
    'DISPID_SLGetWords', 'SpCompressedLexicon', 'SVP_5',
    'SpInprocRecognizer', 'SPINTERFERENCE_TOOLOUD',
    'ISpeechPhoneConverter', 'SAFTTrueSpeech_8kHz1BitMono',
    'SECNormalConfidence', 'SAFTCCITT_uLaw_22kHzStereo',
    'SpWaveFormatEx', 'SPXRO_SML', 'DISPID_SWFESamplesPerSec',
    'SVSFParseSapi', 'DISPID_SVEventInterests',
    'DISPID_SpeechPhraseProperties', 'SpeechVoicePriority',
    'ISpNotifySink', 'DISPID_SRRAlternates', 'SRAONone',
    'SAFT48kHz8BitMono', 'DISPID_SMSSetData',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVP_18', 'SGLexical',
    'SPINTERFERENCE_NOSIGNAL', 'SPSSuppressWord', 'SPRECOSTATE',
    'SPEVENTENUM', 'ISpVoice', 'SpeechCategoryVoices',
    'SpeechTokenContext', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SVEAudioLevel', 'DISPID_SpeechAudio',
    'SPFM_OPEN_READONLY', 'DISPID_SRRTStreamTime',
    'SpeechVisemeFeature', 'SRSInactiveWithPurge',
    'DISPID_SVEPhoneme', 'SDA_One_Trailing_Space',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPGS_EXCLUSIVE', 'SPLEXICONTYPE',
    'ISpeechGrammarRule', 'SDTAudio', 'DISPID_SRState',
    'SpeechAudioFormatType', 'SPPHRASEPROPERTY', 'SPDKL_LocalMachine',
    'ISpeechPhraseAlternates', 'ISpeechBaseStream',
    'DISPID_SRGetFormat', 'SPPS_Unknown', 'eLEXTYPE_PRIVATE8',
    'SPWORD', 'SAFTADPCM_44kHzMono', 'DISPID_SVEBookmark',
    'SPDKL_DefaultLocation', 'SPINTERFERENCE_TOOSLOW',
    'SDTDisplayText', 'ISpObjectWithToken', 'DISPID_SOTCategory',
    'DISPID_SGRsFindRule', 'SPWORDLIST', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRSAudioStatus', 'SLOStatic', 'SVSFNLPSpeakPunc',
    'SPINTERFERENCE_NOISE', 'SGDSInactive', 'DISPID_SpeechFileStream',
    'SREPrivate', 'SASStop', 'SVESentenceBoundary',
    'DISPID_SpeechLexiconWords', 'DISPID_SOTIsUISupported',
    'DISPID_SRCCmdMaxAlternates', 'SpeechStreamSeekPositionType',
    'SPEI_MAX_SR', 'SP_VISEME_7', 'DISPID_SPELexicalForm',
    'SSTTDictation', 'DISPID_SLWsCount', 'SPPS_Verb',
    'SAFT22kHz16BitStereo', 'SPEI_MIN_SR',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SLWsItem', 'SAFT24kHz16BitMono', 'SPXMLRESULTOPTIONS',
    'SpeechWordPronounceable', 'DISPID_SPRuleParent',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SPPsCount', 'DISPID_SRRAudio', 'DISPID_SVSpeak',
    'DISPID_SVSCurrentStreamNumber', 'SPPHRASEELEMENT',
    'DISPID_SDKEnumValues', 'SP_VISEME_18', 'ISpeechAudioFormat',
    'DISPID_SRCERecognition', 'SP_VISEME_8', 'SpStream',
    'DISPID_SRGetPropertyNumber', 'DISPID_SVEWord',
    'SPRST_ACTIVE_ALWAYS', 'SPLOADOPTIONS', 'SPAUDIOBUFFERINFO',
    'SpeechCategoryRecognizers', 'SGSEnabled', 'SREInterference',
    'DISPID_SpeechLexiconProns', 'DISPID_SPPFirstElement',
    'ISpeechXMLRecoResult', 'SBONone',
    'DISPID_SPANumberOfElementsInResult',
    'SpeechRetainedAudioOptions', 'DISPID_SVSLastBookmark',
    'SPEI_REQUEST_UI', 'DISPID_SABIMinNotification',
    'SAFT24kHz8BitStereo', 'ISpeechRecoResult2', 'DISPID_SRGId',
    'SGRSTTWord', 'SPRS_ACTIVE', 'WAVEFORMATEX',
    'SAFTCCITT_uLaw_8kHzStereo', 'SAFTADPCM_11kHzMono',
    'ISpeechRecoGrammar', 'DISPID_SPPs_NewEnum', 'DISPID_SLPSymbolic',
    'ISpeechVoice', 'SPSERIALIZEDPHRASE', 'DISPID_SVIsUISupported',
    'SPPS_RESERVED4', 'SpeechRegistryLocalMachineRoot',
    'SPFM_NUM_MODES', 'DISPID_SMSADeviceId', 'LONG_PTR',
    'SPSERIALIZEDRESULT', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRGDictationUnload',
    'ISpeechAudioBufferInfo', 'SPVPRI_ALERT', 'SP_VISEME_9',
    'SAFTNonStandardFormat', 'SAFT8kHz8BitMono', 'SPEVENTSOURCEINFO',
    'SPBO_TIME_UNITS', 'ISpEventSink', 'SAFTGSM610_22kHzMono',
    'SREPropertyNumChange', 'DISPIDSPTSI', 'SAFTGSM610_8kHzMono',
    'ISpeechVoiceStatus', 'SpeechRecoEvents', 'SPWF_INPUT',
    'SpeechTokenKeyUI', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVWaitUntilDone', 'DISPID_SRCRecognizer',
    'DISPID_SVSInputSentencePosition', 'SPSHORTCUTPAIR',
    'SVSFVoiceMask', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPPEngineConfidence', 'DISPID_SVEVoiceChange',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SOTCreateInstance',
    'SPXRO_Alternates_SML', 'SPCATEGORYTYPE', 'IStream',
    'eLEXTYPE_PRIVATE10', 'DISPID_SGRSTsItem', 'SLTUser',
    'SDKLLocalMachine', 'SpeechRecognizerState',
    'DISPID_SPRuleEngineConfidence', 'SGSExclusive',
    'DISPID_SLGetPronunciations', 'SRARoot', 'SpNotifyTranslator',
    'SPSHORTCUTPAIRLIST', 'eLEXTYPE_PRIVATE2', 'DISPID_SAStatus',
    'SVP_14', 'SRTAutopause', 'DISPID_SPRuleConfidence',
    'DISPID_SOTDataKey', 'SpeechRegistryUserRoot',
    'DISPID_SpeechPhraseRule', 'DISPID_SAFType',
    'SAFT44kHz16BitStereo', 'DISPID_SOTId', 'SSFMCreate',
    'SpeechTokenKeyAttributes', 'SVEAllEvents',
    'DISPID_SRCESoundStart', 'DISPID_SpeechPhraseReplacement',
    'SDTRule', 'SPPS_SuppressWord', 'DISPID_SRDisplayUI', 'SVP_4',
    'SP_VISEME_6', 'eLEXTYPE_PRIVATE9', 'DISPID_SPEDisplayAttributes',
    'DISPID_SVESentenceBoundary', 'DISPID_SVSpeakStream',
    'SAFT22kHz8BitMono', 'ISpRecoCategory',
    'DISPID_SRCERecognitionForOtherContext', 'eLEXTYPE_RESERVED6',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SpeechObjectTokenCategory',
    'ISpeechAudio', 'DISPIDSPTSI_SelectionLength',
    'IInternetSecurityMgrSite', 'DISPID_SRProfile', 'SPEI_HYPOTHESIS',
    'SPSNoun', 'DISPID_SRCState', 'DISPID_SDKGetBinaryValue',
    'SVEViseme', 'eLEXTYPE_PRIVATE1', 'DISPID_SRAudioInputStream',
    'SPEI_RESERVED2', 'DISPID_SPAsItem', 'DISPID_SOTRemove',
    'DISPID_SPPConfidence', 'IEnumString', 'DISPID_SLPType',
    'SpInProcRecoContext', 'DISPID_SRGCmdLoadFromObject',
    'SVSFPurgeBeforeSpeak', 'DISPID_SOTGetAttribute', 'SPSHT_EMAIL',
    'STCInprocServer', 'SpeechBookmarkOptions', 'SAFT12kHz8BitStereo',
    'eLEXTYPE_PRIVATE6', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SWFEFormatTag', 'SECFIgnoreKanaType',
    'DISPID_SGRs_NewEnum', 'DISPID_SPRsCount', 'SRESoundStart',
    'SpeechAudioFormatGUIDText', 'ISpSerializeState', 'SDTAlternates',
    'SSTTWildcard', 'SREStateChange', 'DISPID_SCSBaseStream',
    'ISpeechRecognizer', 'SREPhraseStart', 'SVEBookmark',
    'SPPHRASERULE', 'ISpeechPhraseRules', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRCVoicePurgeEvent', 'SSSPTRelativeToEnd',
    'SGRSTTEpsilon', 'DISPID_SRGReset', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SABIEventBias', 'SPEI_END_INPUT_STREAM',
    'SpeechAudioVolume', 'SVF_Stressed', 'SVSFParseSsml',
    'SPEI_SR_BOOKMARK', 'SVSFNLPMask', 'DISPID_SASetState',
    'DISPID_SPPChildren', 'SpeechVoiceSpeakFlags', 'SPSHT_OTHER',
    'SDA_No_Trailing_Space', 'SpeechRuleAttributes',
    'DISPID_SVEStreamEnd', 'DISPID_SPIAudioSizeBytes', 'SINone',
    'ISpProperties', 'eLEXTYPE_PRIVATE11', 'SVP_21',
    'SpeechPropertyAdaptationOn', 'SP_VISEME_10',
    'DISPID_SADefaultFormat', 'SREAllEvents',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SGRSTPropertyName',
    'SpShortcut', 'SRERecoOtherContext', 'SAFT44kHz8BitStereo',
    'DISPID_SABIBufferSize', 'eLEXTYPE_RESERVED4',
    'Speech_Max_Word_Length', 'DISPID_SRCRequestedUIType',
    'DISPID_SPRuleName', 'SPAR_High', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRCEEnginePrivate',
    'SpeechGrammarState', 'SPFILEMODE', 'SPEI_SR_PRIVATE',
    'DISPID_SPEActualConfidence', 'DISPID_SASNonBlockingIO',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRCBookmark', 'SPSVerb',
    'DISPID_SRStatus', 'SAFT32kHz8BitMono', '_SPAUDIOSTATE',
    'DISPID_SRGRecoContext', 'SVEPhoneme', 'DISPID_SpeechObjectToken',
    'DISPID_SVSkip', 'SVF_None', 'SRTSMLTimeout',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRRPhraseInfo',
    'SAFT44kHz8BitMono', 'SpPhoneConverter', 'SPRECOCONTEXTSTATUS',
    'SAFTCCITT_uLaw_22kHzMono', 'SPEI_SR_RETAINEDAUDIO',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SLWLangId', 'SREBookmark', 'ISpXMLRecoResult',
    'SPAS_PAUSE', 'DISPID_SGRAddResource',
    'DISPID_SRGCmdLoadFromFile', 'SpeechAllElements',
    'DISPID_SpeechPhraseRules', 'SpObjectToken', 'SAFT12kHz8BitMono',
    'SPPS_NotOverriden', 'DISPID_SRCVoice', 'DISPID_SRGCommit',
    'SAFTCCITT_ALaw_22kHzStereo', 'SRTEmulated', 'SASRun',
    'DISPID_SPIReplacements',
    'DISPID_SpeechGrammarRuleStateTransition', 'SpMemoryStream',
    'ISpPhoneticAlphabetSelection', 'SPRS_ACTIVE_USER_DELIMITED',
    'SRSActive', 'ISpeechFileStream', 'DISPID_SRCreateRecoContext',
    'DISPID_SRRSetTextFeedback', 'SPVPRI_OVER',
    'SGDSActiveWithAutoPause', 'SITooLoud', 'SECFEmulateResult',
    'DISPID_SAVolume', 'SPWT_LEXICAL', 'DISPID_SGRInitialState',
    'SVEStartInputStream', 'DISPID_SWFEBlockAlign', 'SRADynamic',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SPRText',
    'DISPID_SPERetainedSizeBytes', 'SPINTERFERENCE_TOOFAST',
    'SRAInterpreter', 'SP_VISEME_1', 'DISPID_SRSSupportedLanguages',
    'SP_VISEME_20', 'DISPID_SRCCreateResultFromMemory',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRCEAdaptation',
    'SPPROPERTYINFO', 'DISPID_SVSRunningState', 'ISpeechRecoResult',
    'SPEI_RECOGNITION', 'ISpeechMemoryStream', 'SGDSActive',
    'DISPID_SpeechMMSysAudio', 'SPPHRASEREPLACEMENT',
    'DISPID_SRGSetTextSelection', 'SPEI_RESERVED6',
    'DISPID_SRIsShared', 'SAFTADPCM_22kHzStereo',
    'DISPID_SGRSTransitions', 'DISPID_SRRGetXMLResult', 'SPWORDTYPE',
    'SPAUDIOSTATUS', 'eLEXTYPE_PRIVATE12', 'DISPID_SVGetAudioOutputs',
    'DISPID_SPEPronunciation', 'SpeechTokenShellFolder',
    'SAFT32kHz8BitStereo', 'IEnumSpObjectTokens', 'SPEI_PHRASE_START',
    'DISPID_SOTGetDescription', 'SRAORetainAudio',
    'SPAO_RETAIN_AUDIO', 'SPDKL_CurrentConfig', 'SVP_20',
    'SpeechPropertyHighConfidenceThreshold', 'Speech_Default_Weight',
    'DISPID_SVSVisemeId', 'SVP_17', 'SPWORDPRONUNCIATION',
    'ISpRecognizer2', 'SpMMAudioIn', 'DISPID_SRRAudioFormat',
    'DISPID_SPRulesCount', 'SFTInput', 'SGDisplay', 'SREAdaptation',
    'SPBO_NONE', 'DISPID_SGRId', 'SPEI_SOUND_START',
    'SpUnCompressedLexicon',
    'SpeechPropertyNormalConfidenceThreshold', 'SPPS_RESERVED2',
    'SPPS_Noun', 'SpVoice', 'DISPID_SVSPhonemeId',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRCESoundEnd'
]
