...
__all__ = [
    'Checked', 'StdFont', 'OLE_YPOS_HIMETRIC', 'IPictureDisp',
    'VgaColor', 'Default', 'FONTSIZE', 'FONTSTRIKETHROUGH',
    'Monochrome', 'OLE_COLOR', 'OLE_ENABLEDEFAULTBOOL', 'IFontDisp',
    'OLE_YSIZE_HIMETRIC', 'OLE_TRISTATE', 'Gray', 'IFontEventsDisp',
    'OLE_XPOS_PIXELS', 'IFont', 'LoadPictureConstants', 'Color',
    'OLE_XSIZE_PIXELS', 'FONTNAME', 'StdPicture', 'FONTUNDERSCORE',
    'OLE_YPOS_CONTAINER', 'OLE_XSIZE_CONTAINER', 'FONTBOLD',
    'OLE_CANCELBOOL', 'FontEvents', 'Font', 'IPicture',
    'OLE_OPTEXCLUSIVE', 'FONTITALIC', 'OLE_XSIZE_HIMETRIC',
    'OLE_YSIZE_PIXELS', 'OLE_HANDLE', 'OLE_XPOS_CONTAINER', 'Picture',
    'OLE_YSIZE_CONTAINER', 'OLE_YPOS_PIXELS', 'Unchecked',
    'OLE_XPOS_HIMETRIC'
]

_check_version('1.1.14', 1680581691.574920)
