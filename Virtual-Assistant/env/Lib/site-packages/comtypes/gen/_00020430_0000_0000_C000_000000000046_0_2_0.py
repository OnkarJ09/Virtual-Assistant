...
__all__ = [
    'OLE_XSIZE_CONTAINER', 'OLE_YPOS_HIMETRIC', 'Font',
    'OLE_YSIZE_CONTAINER', 'IFontEventsDisp', 'StdPicture',
    'VgaColor', 'IFontDisp', 'Gray', 'Picture', 'Default',
    'OLE_OPTEXCLUSIVE', 'OLE_XPOS_CONTAINER', 'Monochrome',
    'OLE_XSIZE_HIMETRIC', 'OLE_YSIZE_HIMETRIC', 'OLE_XPOS_PIXELS',
    'FONTBOLD', 'OLE_CANCELBOOL', 'OLE_YSIZE_PIXELS',
    'FONTSTRIKETHROUGH', 'Checked', 'OLE_YPOS_CONTAINER',
    'OLE_ENABLEDEFAULTBOOL', 'StdFont', 'OLE_COLOR', 'Unchecked',
    'FONTUNDERSCORE', 'FontEvents', 'FONTITALIC', 'OLE_YPOS_PIXELS',
    'Color', 'OLE_XSIZE_PIXELS', 'OLE_HANDLE', 'IPictureDisp',
    'IFont', 'IPicture', 'FONTSIZE', 'LoadPictureConstants',
    'OLE_TRISTATE', 'OLE_XPOS_HIMETRIC', 'FONTNAME'
]

_check_version('1.1.14', 1685306412.623924)
